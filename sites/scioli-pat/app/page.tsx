...
const services: Service[] = [
  {
    ...
    description: 'Full suit fitting and tailoring service, including custom adjustments to jacket, trousers, and silhouette for weddings, events, or everyday wear.',
    icon: 'shirt',
    image: '/photos/photo-3.webp',
  },
  {
    name: 'Garment Alterations',
    description: 'Expert alterations on coats, dresses, pants, and shirts to reshape any garment to your exact frame and preference.',
    icon: 'scissors',
    image: '/photos/photo-4.webp',
  },
  {
    name: 'Suit Sales',
    description: 'Selection of quality suits available for purchase in-shop, with immediate fitting and tailoring included in the experience.',
    icon: 'shopping-bag',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Dress & Coat Reshaping',
    description: 'Structural alterations to reshape oversized or ill-fitting outerwear and dresses so they hug the body and flatter your frame.',
    icon: 'sparkles',
  },
  {
    name: 'Trouser Fitting',
    description: 'Precise trouser tapering, hemming, and waist adjustments to achieve a clean, tailored line from hip to break.',
    icon: 'ruler',
  },
  {
    name: 'Multi-Piece Wardrobe Alterations',
    description: 'Bring in multiple garments for a single consultation — Pat and Anna handle full wardrobe refreshes with the same care as a one-piece job.',
    icon: 'layers',
  },
]
...
const team: TeamMember[] = [
  {
    ...
    credentials: ['Decades of tailoring experience', 'Expert in men\'s suit construction', 'South Philadelphia institution'],
  },
  {
    name: 'Anna Scioli',
    ...
    credentials: ['Expert in women\'s garment alterations', 'Collaborative fitting specialist', 'Trusted by repeat customers for detail-driven work'],
  },
]

const faqItems: FAQItem[] = [
  {
    question: 'What makes Scioli Pat different from a chain tailor or dry cleaner alteration service?',
    answer: 'Pat and Anna work with you directly on every garment — there\'s no middleman, no guesswork, and no assembly line. Customers describe watching them mark up garments together in real time, discussing fit openly. Multiple reviewers have said they\'ll never use a chain clothing store again after experiencing this level of personal attention.',
  },
  {
    question: 'Are the services expensive?',
    answer: 'Pat and Anna\'s services are priced to reflect high-quality, hands-on craftsmanship. One customer noted she paid more for the tailoring than for the coat itself — and called it fully worth every dollar. If you\'re looking for the cheapest option, this isn\'t the place. If you want work done right that makes your clothes look exceptional, the value is clear.',
  },
  {
    question: 'Can I bring in clothes I bought elsewhere to be altered?',
    answer: 'Absolutely. Customers regularly bring in garments purchased from department stores, Amazon, thrift shops, and boutiques. Pat and Anna have transformed everything from cheap online coats to off-the-rack suits into perfectly fitted pieces.',
  },
  {
    question: 'What if I change my mind about the fit when I pick up my clothes?',
    answer: 'Pat and Anna welcome that conversation. One customer requested his trousers be taken in further at pickup and the shop handled it without any issue. They care about the final result, not rushing you out the door.',
  },
  {
    question: 'How long does it typically take to get alterations completed?',
    answer: 'Turnaround times vary based on the complexity of the work and current volume. Simple alterations are generally completed in a reasonable timeframe, though during busy periods it may take longer. It\'s worth calling ahead at (215) 334-0990 to get a current estimate for your specific job.',
  },
  {
    question: 'When is the shop open?',
    answer: 'Scioli Pat is open Tuesday through Saturday from 10:00 AM to 5:00 PM. The shop is closed Sunday and Monday. Given the hands-on nature of the work, it\'s a good idea to call ahead before your first visit.',
  },
]
