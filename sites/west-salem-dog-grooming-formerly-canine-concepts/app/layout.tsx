...
export const metadata: Metadata = {
  ...
  description:
    "Expert dog grooming in Salem, OR. Specializing in show dogs, anxious rescues & first grooms. Linda and her team make dogs actually want to be there.",
  keywords: [
    "dog grooming Salem OR",
    "West Salem dog groomer",
    "show dog grooming Salem",
    "anxiety sensitive dog grooming",
    "large breed dog grooming Salem",
    "puppy first groom Salem Oregon",
    "Canine Concepts Salem Oregon",
    "dog groomer Brush College Road",
  ],
  openGraph: {
