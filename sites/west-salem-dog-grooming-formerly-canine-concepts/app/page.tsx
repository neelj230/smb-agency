...
const services: Service[] = [
  {
    ...
    description:
      "Complete grooming session including breed-appropriate cut, bath, blow-dry, ear cleaning, and a festive or seasonal bandana finish.",
    icon: "scissors",
  ...
  },
  {
    ...
    description:
      "Ring-ready styling for competitive show dogs, with breed-standard cuts and presentation-quality finishing — as trusted by Black Russian Terrier and Shih Tzu show owners.",
    icon: "award",
  ...
  },
  {
    name: "Nail Trim",
    description:
      "Standalone nail trimming service for dogs of all sizes, handled with care and patience.",
    icon: "wrench",
  ...
  },
  {
    ...
    description:
      "Low-stress appointments scheduled during quieter hours for fearful, rescue, or reactive dogs who need a calmer environment.",
    icon: "heart",
  ...
  },
  {
    ...
    description:
      "Gentle introductory grooming session designed to help young or first-time dogs build positive associations with the grooming process.",
    icon: "star",
  ...
  },
  {
    ...
    description:
      "Full grooming services for large and giant breeds — including dogs over 100 pounds — by staff experienced with big dogs' unique handling needs.",
    icon: "shield",
...
const faqItems: FAQItem[] = [
  {
    question:
      "My dog is nervous or anxious around strangers — can you still help?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes — and they do it well. One of their regulars is a 125-pound Black Russian Terrier who comes in for both routine grooming and show preparation. If you have a big dog, don't hesitate to call and discuss your specific needs.",
  },
  {
    question: "Can you groom show dogs to breed standard?",
    answer:
      "Yes. West Salem Dog Grooming has experience with competitive show grooming, including breed-specific styling for dogs like Black Russian Terriers and Shih Tzus. If you're preparing for the ring, the team understands what's required.",
  },
  {
    question:
      "My dog has never been professionally groomed before. Is that okay?",
    answer:
      "It's more common than you'd think, and the team is used to it. They'll take their time, be gentle, and make the first experience as positive as possible. Angela brought her dog Josie in for her very first groom worried about how she'd react — and left saying they took great care of her.",
  },
  {
    question: "What are your hours and how far in advance do I need to book?",
    answer:
      "The salon is open Monday, Tuesday, Thursday, and Friday from 8:30 AM to 4:30 PM. They are closed Wednesday, Saturday, and Sunday. Because the team keeps appointments personal and manageable, it's best to call ahead — especially if your dog has special needs or you want a specific time slot.",
  },
  {
    question: "What happened to Canine Concepts — is this the same place?",
    answer:
      "Yes. West Salem Dog Grooming was formerly known as Canine Concepts. The location, team, and commitment to quality care remain the same — just under a new name that better reflects where they're rooted.",
  },
];
...
const processSteps: ProcessStep[] = [
  {
    ...
    description:
      "Before the bath runs or a brush touches fur, we take a moment to read your dog's energy — anxious, excited, first-timer, or show veteran — so every session starts on the right foot.",
  },
  {
    title: "The Right Appointment, Not Just the Next One",
    description:
      "Nervous dogs get quieter afternoon slots; show dogs get the focused time their breed standard demands — because a one-size-fits-all schedule doesn't serve any dog well.",
  },
  {
    title: "Expert Hands, Breed-Specific Work",
    description:
      "From a gentle puppy introduction to a ring-ready Black Russian Terrier finish, every cut is executed with the care and technique each individual dog deserves.",
  },
  {
    title: "Out the Door Looking — and Feeling — Great",
    description:
      "A seasonal bandana, clean ears, trimmed nails, and a dog that's genuinely happy to have been here — that's the finish line every single visit.",
  },
];
...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "White dog wearing festive bandana posed with Santa figurine and wrapped gifts",
    category: "product",
  },
  {
  ...
  },
  {
    ...
    alt: "Groomed Shih Tzu dog wearing purple bow tie at show or grooming salon",
    category: "product",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Wheaten Terrier standing on pink grooming table during professional dog grooming session",
    category: "product",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Two black and white dogs sitting on wooden floor in kitchen setting",
    category: "interior",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Small black and white dog standing on pink yoga mat in indoor fitness studio.",
    category: "work",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Brown dog sitting on purple mat against white wall indoors",
    category: "product",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "White fluffy dog wearing black floral bandana, smiling at camera indoors.",
    category: "product",
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div id="faq">
          <FAQAccordion
            heading="Things You Were Going to Ask Anyway"
            items={faqItems}
          />
        </div>
