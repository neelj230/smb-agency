...
const services: Service[] = [
  {
    ...
    description: 'Custom acrylic nail sets and monthly refills crafted with precision — Mai\'s specialty, trusted by long-term clients who return month after month.',
    icon: 'sparkles',
    image: '/photos/photo-3.webp',
  },
  {
    name: 'Pedicure',
    description: 'Thorough pedicure services including specialized ingrown toenail care, performed with attention to comfort and detail.',
    icon: 'footprints',
    image: '/photos/photo-4.webp',
  },
  {
    name: 'Gel Manicure',
    description: 'Long-lasting gel polish applied over shaped nails for a glossy, chip-resistant finish that keeps hands looking polished for weeks.',
    icon: 'wand',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Nail Art & Custom Designs',
    description: 'Intricate nail art and custom designs that clients describe as \'masterpieces\' — the kind of work that draws compliments long after you leave the salon.',
    icon: 'palette',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'Eyebrow Services',
    description: 'Clean, defined eyebrow shaping and waxing to complete your look from head to toe.',
    icon: 'eye',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Classic Manicure',
    description: 'A foundational manicure — nail shaping, cuticle care, and polish — executed with the detail-oriented approach T&C is known for.',
    icon: 'scissors',
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'T&C Nail Salon accepts walk-ins. The salon opens at 9:00 AM Tuesday through Saturday (closed Wednesday and Sunday). Many loyal clients arrive early — sometimes before opening — to secure their preferred technician, especially for specialists like Mai or Anna.',
  },
  {
    question: 'Can I request a specific nail technician?',
    answer: 'Yes, and many regulars do exactly that. Clients frequently request Mai for acrylic refills and Anna for pedicures and ingrown toenail care. If you have a preference, it\'s worth arriving early or calling ahead to (215) 472-4377.',
  },
  {
    question: 'What makes T&C different from other nail salons in West Philly?',
    answer: 'Long-term clients consistently point to three things: the quality of the work (described as \'masterpieces\'), the professional and welcoming atmosphere, and the consistency that keeps people returning for 9+ years. Multiple reviewers independently called it the best nail salon in West Philadelphia.',
  },
  {
    question: 'Do you offer eyebrow services in addition to nails?',
    answer: 'Yes. T&C offers eyebrow services alongside their full nail menu. Clients recommend it as a one-stop visit for hands, feet, and brows.',
  },
  {
    question: 'How should I handle a concern about my nails during my visit?',
    answer: 'T&C\'s best experiences happen when communication is open and respectful on both sides — the team takes pride in their work and values client feedback. If something doesn\'t look right, raise it calmly and directly with your technician.',
  },
  {
    question: 'What are the salon\'s hours and is there a day they\'re closed?',
    answer: 'T&C is open Tuesday, Thursday, Friday, and Saturday from 9:00 AM to 5:30 PM, and Monday from 9:00 AM to 5:30 PM. The salon is closed on Wednesdays and Sundays. Plan your visit accordingly — Saturday tends to be busy.',
  },
]
...
const processSteps: ProcessStep[] = [
  {
    ...
    description: 'Tell us who you want — Mai for acrylics, Anna for pedicures and ingrown care, or Mom for a classic set — and we\'ll make sure you\'re in the right hands.',
  },
  {
    title: 'Settle Into the Chair',
    description: 'From the moment you sit down, the energy is warm, professional, and focused entirely on you.',
  },
  {
    title: 'Watch the Detail Work Happen',
    description: 'Every shape, every layer, every finish is applied with the precision that\'s kept clients loyal for nearly a decade.',
  },
  {
    title: 'Leave Ready for Compliments',
    description: 'Walk out the door with nails that do the talking — and a standing appointment already in your head.',
  },
]
...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: 'T&C Nail salon photo 3', category: 'work' },
  { src: '/photos/photo-4.webp', alt: 'T&C Nail salon photo 4', category: 'work' },
  { src: '/photos/photo-5.webp', alt: 'T&C Nail salon photo 5', category: 'work' },
  { src: '/photos/photo-6.webp', alt: 'T&C Nail salon photo 6', category: 'work' },
  { src: '/photos/photo-7.webp', alt: 'T&C Nail salon photo 7', category: 'work' },
  { src: '/photos/photo-8.webp', alt: 'T&C Nail salon photo 8', category: 'work' },
  { src: '/photos/photo-9.webp', alt: 'T&C Nail salon photo 9', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'T&C Nail salon photo 10', category: 'work' },
]
