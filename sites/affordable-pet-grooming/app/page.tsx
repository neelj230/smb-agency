...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Cream-colored dog with white chest lying on gray quilted couch wearing blue collar",
    category: "interior",
  },
  {
    src: "/photos/photo-3.webp",
    alt: "Black and white dog standing on green carpet in living room with blue sofa",
    category: "interior",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "Three small gray and white dogs wearing pink bows on a porch.",
    category: "product",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Child in orange shirt playing with colorful toys and fabrics indoors",
    category: "interior",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Small dog wearing gray houndstooth harness sitting in car",
    category: "product",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Black dog resting on colorful blanket indoors near bed",
    category: "interior",
  },
];
...
const services: Service[] = [
  {
    ...
    description:
      "Complete breed-specific grooming including bath, dry, cut, and styling tailored to your dog's coat type — from golden retrievers to schnauzers.",
    icon: "scissors",
  ...
  },
  {
    ...
    description:
      "Slow, patient grooming sessions specially suited for fearful, traumatized, or rescue dogs who need extra time and a calm, gentle approach.",
    icon: "heart",
  ...
  },
  {
    name: "Bath & Brush Out",
    description:
      "Thorough shampoo, conditioning rinse, and full brush-out to remove loose fur, tangles, and odor — leaving coats clean and manageable.",
    icon: "droplets",
  ...
  },
  {
    name: "Trim & Tidy",
    description:
      "Targeted trimming of paws, face, ears, and sanitary areas to keep your dog neat between full grooming appointments.",
    icon: "crop",
  ...
  },
  {
    ...
    description:
      "Cute finishing accessories including bows, bandanas, and ear adornments — as seen on the shop's adorable trio of bow-wearing pups.",
    icon: "sparkles",
  ...
  },
  {
    ...
    description:
      "Staff flag visible health concerns — like flea infestations or skin irregularities — so owners leave informed and prepared to follow up with their vet.",
    icon: "stethoscope",
...
const faqItems: FAQItem[] = [
  {
    question:
      "My dog is a rescue with serious anxiety around grooming. Can you help?",
    answer:
      "Yes — this is genuinely one of the shop's specialties. One customer brought in a rescue with abuse-related fear so severe that grooming was nearly impossible anywhere else. The team worked patiently and transformed his experience completely.",
  },
  {
    question: "The prices seem really low. Is the quality actually good?",
    answer:
      "Multiple customers have had the same reaction — and the same pleasant surprise. A golden retriever owner admitted being nervous about the pricing, then called it the best groom her dog had ever had. Low prices don't mean low standards here.",
  },
  {
    question: "Can I get a same-day or last-minute appointment?",
    answer:
      "It's worth calling — at least two customers have successfully been fit in on short notice. The shop runs a streamlined model, so there's often flexibility. Call (503) 391-5643 and ask.",
  },
  {
    question: "What are your hours and days of operation?",
    answer:
      "Affordable Pet Grooming is open Tuesday through Saturday from 8:00 AM to 2:00 PM. They are closed Sunday and Monday. Give them a call to book your appointment.",
  },
];
      ...
      <div className="apg-tagline-strip">
        <div className="apg-tagline-inner">
          {[
            ...
            <span key={i} className="apg-tagline-pill">
              {t}
            </span>
          ))}
        </div>
