...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-1.webp', alt: 'Apricot poodle wearing skeleton-patterned bandana in indoor setting', category: 'product' },
  { src: '/photos/photo-2.webp', alt: 'White fluffy dog wearing colorful toy collar held by man indoors', category: 'product' },
  { src: '/photos/photo-3.webp', alt: 'Small white Shih Tzu dog wearing purple and green collar bow, looking upward', category: 'product' },
  { src: '/photos/photo-6.webp', alt: 'Cream-colored Goldendoodle lying on dark speckled floor against beige wall', category: 'interior' },
  { src: '/photos/photo-7.webp', alt: 'Persian cat with white and gray fur sitting in car seat', category: 'product' },
  { src: '/photos/photo-8.webp', alt: 'Adorable Shih Tzu puppy wearing gray and white scarf, smiling at camera', category: 'product' },
  { src: '/photos/photo-9.webp', alt: 'Black and white cat lying on teal patterned bedding, looking at camera', category: 'product' },
  { src: '/photos/photo-10.webp', alt: 'White fluffy dog with red heart tag sitting by window indoors', category: 'interior' },
]
...
const services: Service[] = [
  {
    ...
    description: 'Complete bath, blow-dry, breed-appropriate trim, and finishing touches that leave your dog looking their absolute best.',
    icon: 'scissors',
    image: '/photos/photo-1.webp',
  },
  {
    name: 'Nail Trim & Dew Claw Care',
    description: 'Precise nail trimming including dew claws, handled with calm technique that even the most resistant dogs tolerate.',
    icon: 'pointer',
    image: '/photos/photo-2.webp',
  },
  {
    name: 'Anal Gland Expression',
    description: 'Professional anal gland relief performed safely and efficiently as a standalone or add-on service.',
    icon: 'heart-pulse',
    image: '/photos/photo-3.webp',
  },
  {
    name: 'Cat Grooming & Bathing',
    description: 'Full grooming services for cats including baths, blow-dry, and coat care — including multi-bath sessions for long or heavily-coated breeds.',
    icon: 'cat',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'Bath & Brush-Out',
    description: "Deep cleansing bath, ear cleaning, and thorough brush-out to detangle and refresh your dog's coat between full grooms.",
    icon: 'sparkles',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Walk-In Nail & Quick Services',
    description: 'Fast, no-fuss walk-in nail trims and minor grooming needs completed while you wait — no appointment required.',
    icon: 'zap',
...
const faqItems: FAQItem[] = [
  {
    question: 'My dog hates being groomed and gets really anxious. Can you help?',
    answer: "Yes — this is actually one of Lucky Dog's strongest suits. Multiple customers report that dogs who shook, barked, or fought at other salons come here calm and leave happy. The team works at a pace that keeps your pet comfortable.",
  },
  {
    question: 'Do you groom cats as well as dogs?',
    answer: 'Absolutely. Lucky Dog is one of the few salons in the area that grooms cats, including long-haired and heavily-coated breeds that need multiple baths. If your cat needs grooming, they can handle it.',
  },
  {
    question: 'Do you accept walk-ins?',
    answer: 'Yes, walk-ins are welcome when the schedule allows. One customer walked in with a teacup chihuahua needing a nail trim and was taken care of right away. Call ahead if you want to confirm availability.',
  },
  {
    question: 'How are your prices compared to other groomers?',
    answer: 'Lucky Dog is consistently described as affordable by customers, especially given the quality of work. Customers with multiple pets or larger breeds find the pricing fair and worth every penny.',
  },
]
