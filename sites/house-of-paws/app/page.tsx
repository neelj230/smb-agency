...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-1.webp', alt: 'Groomed small dog with cream and white coat standing indoors on mat', category: 'product' },
  { src: '/photos/photo-2.webp', alt: 'Fluffy cream-colored Chihuahua groomed professionally, standing in grooming salon.', category: 'work' },
  { src: '/photos/photo-3.webp', alt: 'Small tan dog with pink collar sitting on grooming table in pet salon', category: 'interior' },
  { src: '/photos/photo-4.webp', alt: 'Two small dogs relaxing on green bedding in an indoor play area', category: 'interior' },
  { src: '/photos/photo-5.webp', alt: 'Brown and white dog standing in metal trough enclosure with green corrugated walls', category: 'interior' },
  { src: '/photos/photo-7.webp', alt: 'Close-up of a long-haired dog with curly, fluffy coat in grooming setting', category: 'product' },
  { src: '/photos/photo-8.webp', alt: 'Young woman smiling while bathing a gray dog in a metal tub at a grooming facility.', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'Dog wearing red gingham bandana on grooming table at pet salon', category: 'work' },
]
...
const faqItems: FAQItem[] = [
  ...
  {
    question: 'What makes House of Paws different from other groomers in Medford?',
    answer:
...
// ─── Marquee strip ──────────────────────────────────────────────
const marqueeWords = [
  'Dog Grooming', '✦', 'Self-Serve Wash', '✦', 'Puppy\'s First Groom', '✦',
  'Nail Trims', '✦', 'Medford OR', '✦', 'Open 7 Days', '✦',
  'Dog Grooming', '✦', 'Self-Serve Wash', '✦', 'Puppy\'s First Groom', '✦',
  'Nail Trims', '✦', 'Medford OR', '✦', 'Open 7 Days', '✦',
]
  ...
  return (
    <>
      ...
      <section id="services" className="section-generous dot-pattern">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="section-sub">
            From full spa days to a quick nail trim — we've got your pup covered.
          </motion.p>
        </motion.div>
        <ServiceCards
          heading=""
        ...
        <section id="about" className="section-generous">
          <div className="section-container">
            <motion.div
              ...
              variants={stagger}
            >
              <motion.span variants={fadeUp} className="eyebrow-pill eyebrow-light">
                Who We Are
              </motion.span>
              <motion.h2 variants={fadeUp} className="section-heading-xl text-white mt-4">
      ...
      {/* ══════════════════════════════════════════════════════════
          GALLERY
      ══════════════════════════════════════════════════════════ */}
      <section id="gallery" className="section-generous" style={{ background: 'var(--brand-surface)' }}>
        <motion.div
          className="section-container"
          initial="hidden"
          whileInView="visible"
          ...
          variants={stagger}
        >
          <motion.span variants={fadeUp} className="eyebrow-pill">Fresh From the Salon</motion.span>
      ...
      <div className="accent-cta-band">
        <div className="accent-cta-inner">
          ...
          >
            ...
            <h2 className="accent-cta-headline">Your dog's spa day is one call away.</h2>
          </motion.div>
          <motion.a
            href="tel:5419732101"
      ...
      <section id="faq" className="section-generous">
        <motion.div
          ...
          variants={stagger}
        >
          <motion.span variants={fadeUp} className="eyebrow-pill">Got Questions?</motion.span>
          <motion.h2 variants={fadeUp} className="section-heading-xl mt-4">
            Common Questions
          </motion.h2>
        </motion.div>
