...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Creative Vases photo 3",
    category: "work",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "Creative Vases photo 4",
    category: "work",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Creative Vases photo 5",
    category: "work",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "Creative Vases photo 6",
    category: "work",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Creative Vases photo 7",
    category: "work",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Creative Vases photo 8",
    category: "work",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Creative Vases photo 9",
    category: "work",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "Creative Vases photo 10",
    category: "work",
  },
];
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "We're a real West Philly shop — daily-fresh flowers, prices that work for neighbors, and a studio space where workshops and awareness events actually happen. Small, personal, rooted in the block.",
  },
];
      ...
      <div className="cv-marquee-track">
        {doubled.map((item, i) => (
          <span key={i} className="cv-marquee-item">
            <span className="cv-marquee-dot" style={{ color: "#1a1a14" }}>
              ✦
            </span>
            {item}
          </span>
