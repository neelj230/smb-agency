...
const heroPhoto: Photo = {
  ...
  alt: "Mai Lashes & Nail Spa storefront in Southwest Philadelphia",
  category: "exterior",
};

const aboutPhoto: Photo = {
  src: "/photos/photo-2.webp",
  alt: "Inside Mai Lashes & Nail Spa on South 70th Street",
  category: "interior",
};

const galleryPhotos: Photo[] = [
  { src: "/photos/photo-3.webp", alt: "Fresh builder gel manicure at Mai Lashes & Nail Spa", category: "work" },
  { src: "/photos/photo-4.webp", alt: "Custom acrylic nail set — clean shape work", category: "work" },
  { src: "/photos/photo-5.webp", alt: "Gel manicure finish detail", category: "work" },
  { src: "/photos/photo-6.webp", alt: "Nail design completed by Win", category: "work" },
  { src: "/photos/photo-7.webp", alt: "Precision nail shaping at Mai's", category: "work" },
  { src: "/photos/photo-8.webp", alt: "Full acrylic set — Mai Lashes & Nail Spa", category: "work" },
  { src: "/photos/photo-9.webp", alt: "Polished nails from a first-time client visit", category: "work" },
  { src: "/photos/photo-10.webp", alt: "Immaculate shape — client's words", category: "work" },
];
...
const services: Service[] = [
  {
    ...
    description:
      "A durable, sculpted gel application praised by customers for its flawless shape and long-lasting finish.",
    icon: "sparkles",
  ...
  },
  {
    ...
    description:
      "Custom acrylic sets shaped and finished to your preference, with consistently clean, precise results.",
    icon: "wand-2",
  ...
  },
  {
    name: "Gel Manicure",
    description:
      "A chip-resistant gel polish manicure with a glossy, salon-quality finish that lasts for weeks.",
    icon: "paint-bucket",
  ...
  },
  {
    ...
    description:
      "A quick, expertly finished manicure ideal for maintaining neat, polished nails between appointments.",
    icon: "hand",
  ...
  },
  {
    name: "Lash Services",
    description:
      "Professional eyelash enhancements to complement your nail look, offered alongside the salon's core nail menu.",
    icon: "eye",
  ...
  },
  {
    name: "Pedicure",
    description:
      "A relaxing foot care treatment including nail shaping, cuticle work, and polish in your choice of finish.",
    icon: "footprints",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Walk-ins are welcome and often accommodated right away — at least one customer was seated and served immediately upon arrival. Calling ahead helps during busy periods.",
  },
  {
    question: "How long does a typical nail appointment take?",
    answer:
      "Appointments are known for being efficient without feeling rushed. Clients have reported being in and out in under 20 minutes for simpler services.",
  },
  {
    question: "Is this a good salon for first-time visitors?",
    answer:
      "Absolutely. Multiple first-time clients left 5-star reviews and immediately said they'd be back. The technicians communicate well and make new clients feel comfortable.",
  },
  {
    question: "Can I request a specific technician like Win?",
    answer:
      "Yes — calling ahead to request Win or another preferred technician is the best way to ensure availability. Win is a frequently requested technician known for immaculate shape work.",
  },
];
      ...
      <div className="mai-marquee-track">
        {doubled.map((item, i) => (
          <span key={i} className="mai-marquee-item">
            <span
              className="mai-marquee-dot"
              style={{ color: BRAND.cream, opacity: 0.5 }}
            >
              ◆
            </span>
            <span
...
function CopperDivider({ light = false }: { light?: boolean }) {
  return (
    ...
    >
      ...
      <span
        style={{
          color: light ? "rgba(255,255,255,0.5)" : BRAND.copper,
          fontSize: "0.65rem",
        }}
      >
        ◆
    ...
    <>
      ...
      <section id="about" style={{ background: "#fff", padding: "80px 0" }}>
        <FadeUp>
          <AboutSection
            ...
            story="Mai Lashes & Nail Spa has built its reputation one flawless set at a time on South 70th Street. Win and the team communicate clearly, work precisely, and turn first-time visitors into regulars — Paul Thomas's daughter was in and out in under 20 minutes with exactly what she wanted. Walk-ins welcome."
            image={aboutPhoto}
          />
        </FadeUp>
      </section>
      ...
      <section
        ...
        style={{
          ...
          ["--brand-muted" as never]: "rgba(255,255,255,0.78)",
        }}
      >
        <FadeUp>
          <div
