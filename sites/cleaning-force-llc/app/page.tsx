...
// ── Photos ───────────────────────────────────────────────────
const heroPhoto: Photo = { src: '/photos/photo-1.webp', alt: 'Cleaning Force LLC photo 1', category: 'exterior' }
const aboutPhoto: Photo = { src: '/photos/photo-2.webp', alt: 'Cleaning Force LLC photo 2', category: 'interior' }
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: 'Cleaning Force LLC photo 3', category: 'work' },
  { src: '/photos/photo-4.webp', alt: 'Cleaning Force LLC photo 4', category: 'work' },
  { src: '/photos/photo-5.webp', alt: 'Cleaning Force LLC photo 5', category: 'work' },
  { src: '/photos/photo-6.webp', alt: 'Cleaning Force LLC photo 6', category: 'work' },
  { src: '/photos/photo-7.webp', alt: 'Cleaning Force LLC photo 7', category: 'work' },
  { src: '/photos/photo-8.webp', alt: 'Cleaning Force LLC photo 8', category: 'work' },
  { src: '/photos/photo-9.webp', alt: 'Cleaning Force LLC photo 9', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'Cleaning Force LLC photo 10', category: 'work' },
]
...
const services: Service[] = [
  {
    name: 'Deep Cleaning',
    description: 'A comprehensive top-to-bottom clean covering every room, appliance, corner, and surface — perfect for first-time clients or homes that need a serious reset.',
    icon: 'sparkles',
    image: '/photos/photo-3.webp',
  },
  {
    name: 'Move-Out Cleaning',
    description: 'Detailed move-out cleans designed to leave rental properties spotless, help tenants recover security deposits, and prepare homes for the next occupant.',
    icon: 'door-open',
    image: '/photos/photo-4.webp',
  },
  {
    name: 'Recurring Home Cleaning',
    description: 'Scheduled weekly, bi-weekly, or monthly cleans that keep your home consistently spotless so you never have to think about it.',
    icon: 'calendar-check',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Appliance & Kitchen Cleaning',
    description: 'Focused cleaning of stovetops, ovens, refrigerators, and kitchen surfaces — restored to better-than-new condition using professional-grade supplies.',
    icon: 'utensils',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'Move-In Cleaning',
    description: 'Thorough pre-move-in cleans that ensure your new space is sanitized, fresh, and truly ready for you to call home from day one.',
    icon: 'home',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Last-Minute & Emergency Cleaning',
    description: "Rapid-response cleaning bookable with less than 48 hours notice — available 24/7 for situations that can't wait.",
    icon: 'zap',
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'Cleaning Force can accommodate bookings with less than 48 hours notice. Their online booking system is fast and straightforward — reach out by phone or the web form to lock in a time.',
  },
  {
    question: 'What makes Cleaning Force different from other cleaning companies?',
    answer: "Customers consistently highlight three things: attention to detail that goes beyond what's asked, reliable communication throughout the process, and results that make homes look and smell brand new every single time.",
  },
  {
    question: 'Do you offer a satisfaction guarantee?',
    answer: 'Yes. Cleaning Force offers a customer satisfaction guarantee, giving clients peace of mind that their space will be cleaned to a high standard — or they will make it right.',
  },
  {
    question: 'What does your move-out cleaning include?',
    answer: 'Move-out cleans cover all rooms including kitchens, bathrooms, living spaces, appliances (inside and out), floors, carpets, and baseboards. Everything a landlord or new tenant expects to find spotless.',
  },
]
      ...
      <div className="cf-pullquote-inner">
        <Reveal>
          ...
          <p className="cf-pullquote-text">
            My house is spotless and smells amazing. Cleaning Force never disappoints.
          </p>
          <p className="cf-pullquote-attr">— Shannon Artis, Philadelphia</p>
        </Reveal>
      </div>
      <div className="cf-pullquote-photo-col">
        <img src="/photos/photo-9.webp" alt="Clean home by Cleaning Force" className="cf-pullquote-photo" />
      </div>
    </div>
  )
}
        ...
        <Reveal>
          <div className="cf-section-header">
            ...
            <p className="cf-section-sub">
              From last-minute emergencies to scheduled weekly visits — we handle it all.
            </p>
          </div>
        </Reveal>
        <ServiceCards
      ...
      <div id="faq" className="cf-dark-wrap cf-faq-wrap">
        <Reveal>
          <div className="cf-section-header cf-section-header--light">
            <span className="cf-overline cf-overline--yellow">Common Questions</span>
