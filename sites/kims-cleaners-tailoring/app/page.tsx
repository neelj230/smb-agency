...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: "Kim's Cleaners & Tailoring photo 3", category: 'work' },
  { src: '/photos/photo-4.webp', alt: "Kim's Cleaners & Tailoring photo 4", category: 'work' },
  { src: '/photos/photo-5.webp', alt: "Kim's Cleaners & Tailoring photo 5", category: 'work' },
  { src: '/photos/photo-6.webp', alt: "Kim's Cleaners & Tailoring photo 6", category: 'work' },
  { src: '/photos/photo-7.webp', alt: "Kim's Cleaners & Tailoring photo 7", category: 'work' },
  { src: '/photos/photo-8.webp', alt: "Kim's Cleaners & Tailoring photo 8", category: 'work' },
  { src: '/photos/photo-9.webp', alt: "Kim's Cleaners & Tailoring photo 9", category: 'work' },
  { src: '/photos/photo-10.webp', alt: "Kim's Cleaners & Tailoring photo 10", category: 'work' },
]
...
const faqItems: FAQItem[] = [
  ...
  {
    question: 'What if I have a last-minute alteration request close to my event?',
    answer:
  ...
  {
    question: 'Will you give me an honest opinion on whether my garment can be altered well?',
    answer:
          ...
          <div className="kc-marquee-track">
            {[
              ...
              <span key={i} className="kc-marquee-tag">
                {i % 2 === 0 ? (
                  <svg width="10" height="10" viewBox="0 0 10 10" fill={ACCENT} aria-hidden>
