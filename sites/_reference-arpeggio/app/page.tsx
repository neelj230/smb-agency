...
const stats = [
  ...
  { label: "Colours Not in Use", value: 3 },
];
...
const services = [
  {
    ...
    title: "Branding",
    description:
      "From strategy to execution, we create authentic brand experiences that connect with your audience and foster lasting relationships.",
    items: [
      "Brand Strategy",
      "Brand Identity",
      "Visual Identity",
  ...
  },
  {
    ...
    title: "Digital",
    description:
      "We combine strategic thinking with creative design to deliver digital solutions that enhance user experience and drive engagement.",
    items: [
      "Digital Strategy",
      "UX Design",
      "Concept Design",
  ...
  },
  {
    ...
    title: "Development",
    description:
      "Using cutting-edge technology, we build robust and scalable solutions that bring your digital vision to reality.",
    items: [
...
const testimonials = [
  {
    quote:
      "Cadenza transformed our brand completely. The attention to detail and creative vision exceeded all expectations.",
    name: "Sarah Chen",
  ...
  {
    quote:
      "Working with this team felt like having an in-house creative department. Fast turnaround and brilliant execution.",
    name: "Marcus Wright",
  ...
  {
    quote:
      "The subscription model is genius. We get unlimited iterations and the quality never drops. Best investment we made.",
    name: "Priya Sharma",
  ...
  {
    quote:
      "Their design sense is unmatched. Every project feels fresh, bold, and perfectly aligned with our brand identity.",
    name: "James Porter",
    role: "Creative Lead",
    rating: 5,
  },
  {
    quote:
      "From branding to web development, they handle everything with the same level of excellence. Truly a one-stop shop.",
    name: "Elena Rossi",
  ...
  {
    quote:
      "The team understood our vision from day one. The final product was even better than what we imagined.",
    name: "David Kim",
...
const faqs = [
  {
    q: "What can I expect within 48 hours?",
    a: "You'll receive an initial mockup or design draft, giving you a first look at our creative direction for your project.",
  },
  {
    q: "How does the subscription model work?",
    a: "Our subscription model offers unlimited design requests for a flat monthly fee, allowing you to submit as many tasks as needed.",
  },
  {
    q: "Can I pause my subscription if needed?",
    a: "Yes, our flexible subscription allows you to pause or adjust your plan at any time to accommodate your business needs.",
  },
  {
    q: "Who will I be working with?",
    a: "You'll be assigned a dedicated design expert and have access to a team of specialists to ensure your project succeeds.",
  },
  {
    q: "How do revisions work?",
    a: "We offer unlimited design iterations, working closely with you to refine the project until it meets your exact vision.",
  },
];
    ...
    <>
      ...
      >
        <div className="sticky top-0 h-screen w-full overflow-hidden">
          ...
          {/* "One subscription, unlimited design iterations." (left) */}
          <motion.div
          ...
          >
            <h1 className="hero-text-pan text-[clamp(5rem,18vw,16rem)] font-extrabold leading-[0.85] tracking-[-0.04em] text-[var(--brand-accent)] whitespace-nowrap">
              Cadenza<sup className="text-[0.3em] align-super">&reg;</sup>
            </h1>
          </motion.div>
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ACHIEVEMENTS / STATS — Arpeggio style with image + watch reel
      ═══════════════════════════════════════════════════════════════════════ */}
      <section className="relative py-24 lg:py-36 px-6 lg:px-12 bg-[var(--brand-bg-dark)] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_1fr] gap-8 mb-16">
            {/* Left: VR person image with "watch reel" overlay */}
            <motion.div
            ...
            <div className="flex flex-col justify-between gap-6">
              ...
              >
                ...
                <p className="text-white/50 text-sm mb-4 leading-relaxed">
                  Arpeggio is thrilled to announce our triumph at the Cannes
                  Lynx, winning the award for our dynamic campaign with the
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          WHAT WE DO — Expanding circle reveal + huge text + Arpeggio layout
      ═══════════════════════════════════════════════════════════════════════ */}
        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          >
            <div className="max-w-6xl mx-auto w-full">
              ...
              {/* Services list — Arpeggio style: number + title left, description center, items right */}
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          WHY CHOOSE US — Arpeggio bento grid with images and sliding elements
      ═══════════════════════════════════════════════════════════════════════ */}
      <section className="relative py-24 lg:py-36 px-6 lg:px-12 bg-[var(--brand-bg)] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Bento Grid — matching Arpeggio reference */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {/* Row 1 */}
            {/* Premium Plans - large card with image */}
            <motion.div
            ...
            {/* Design Dashboard with sliding preview */}
            <motion.div
            ...
            >
              ...
              <p className="text-white/70 text-[10px] mb-3">
                Monitor progress and manage requests effortlessly
              </p>
            ...
            {/* Row 3 */}
            {/* Real-time progress tracking with sliding cards */}
            <motion.div
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 pt-20 pb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-white/10">
            ...
            <div className="text-center">
              <p className="text-white/40 text-xs">Cadenza SRL</p>
