...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Happy golden doodle dog sitting in car back seat wearing blue collar and leash",
    category: "interior",
  },
  {
    src: "/photos/photo-2.webp",
    alt: "French Bulldog wearing sweater sitting in wicker basket on couch by window",
    category: "interior",
  },
  {
    src: "/photos/photo-3.webp",
    alt: "Small black dog wearing pink collar and colorful sunflower bandana on patterned rug",
    category: "product",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Small dog wearing colorful patterned bandana and green leash indoors",
    category: "product",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "Black dog with tongue out lying on wooden floor indoors",
    category: "interior",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Black Scottish Terrier sitting in gray armchair with city skyline view through window",
    category: "interior",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Black fluffy small dog standing on colorful patterned rug indoors",
    category: "interior",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "White poodle grooming competition entry showing before and after styling results",
    category: "product",
  },
];
...
const services: Service[] = [
  {
    ...
    description:
      "A complete grooming session including bath, blow-dry, breed-specific or custom haircut, and finishing touches like bandanas or bows.",
    icon: "scissors",
  ...
  },
  {
    ...
    description:
      "A slow, gentle, one-on-one grooming experience designed specifically for nervous, shy, or rescue dogs who need extra patience and trust-building.",
    icon: "heart",
  ...
  },
  {
    ...
    description:
      "Early grooming sessions that condition young puppies to the grooming process, building comfort and confidence from their very first visit.",
    icon: "star",
  ...
  },
  {
    name: "Bath & Brush Out",
    description:
      "A thorough bath, conditioning treatment, and professional blow-out to keep your dog clean, fresh, and tangle-free between full grooms.",
    icon: "droplets",
  ...
  },
  {
    ...
    description:
      "Nail clipping, filing, and optional ear cleaning or paw pad care as a standalone service or add-on to any groom.",
    icon: "sparkles",
  ...
  },
  {
    ...
    description:
      "Precision cuts tailored to your dog's breed standard or your personal preference, from Goldendoodle trims to Pomeranian shaping and Scottie profiles.",
    icon: "award",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Absolutely — anxious and fearful dogs are actually something Kaley specializes in. Multiple clients have brought in rescue dogs and seniors with real grooming anxiety, and Kaley's slow, patient, one-on-one approach has transformed those experiences completely.",
  },
  {
    question: "Do you work with puppies who have never been groomed before?",
    answer:
      "Yes, and starting early is actually ideal. Kaley worked with Vinny the mini Goldendoodle from just 4 months old, training him gently so that grooming felt normal and safe from the very beginning.",
  },
  {
    question: "What makes Emerald K9 different from a typical grooming salon?",
    answer:
      "Emerald K9 is a private, one-on-one studio — not a high-volume shop. Kaley sees one dog at a time, which keeps the environment quiet, calm, and stress-free. Your dog isn't crated next to strangers for hours.",
  },
  {
    question: "How often should I bring my dog in for grooming?",
    answer:
      "It depends on your dog's breed, coat type, and lifestyle, but most clients with doodles, poodles, and similar breeds visit every 6–8 weeks. Kaley will give you a personalized recommendation at your first visit.",
  },
];
