...
const services: Service[] = [
  {
    ...
    description:
      "Complete bath, dry, breed-appropriate haircut, and finish styling tailored to your instructions — done with the kind of careful attention that leaves dogs soft, handsome, and visibly happier.",
    icon: "scissors",
  ...
  },
  {
    name: "Nail Trim",
    description:
      "A quick, gentle nail trim for just $5 cash — staff will even let you hold your pet during the process for anxious or small dogs.",
    icon: "star",
  ...
  },
  {
    name: "Bath & Brush Out",
    description:
      "Deep cleansing bath with blow-dry and full brush-out to remove mats, loose fur, and dander — ideal for fluffy breeds like Pomeranians and golden retrievers.",
    icon: "droplets",
  ...
  },
  {
    ...
    description:
      "A calm, patient approach specifically suited for rescue dogs, reactive pets, or animals with past grooming trauma — Maddox and the team are known for turning shaking, alarmed dogs into relaxed ones.",
    icon: "heart",
  ...
  },
  {
    ...
    description:
      "Specialized handling for small and toy breeds who need extra gentleness — accommodations like owner-assisted nail trims are available on request.",
    icon: "dog",
  ...
  },
  {
    ...
    description:
      "Full grooming services for larger dogs like golden retrievers, priced fairly for the size and skill involved — Ezra is especially praised for his work with big dogs.",
    icon: "shield-check",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Unlike most Portland groomers who are booked out for months, we're known for quick availability and flexible scheduling. Multiple clients have specifically praised how fast they were able to get in. Call us at (503) 233-2799 to check current openings.",
  },
  {
    question:
      "My dog has anxiety and has had bad experiences at other groomers. Can you help?",
    answer:
      "Absolutely — this is one of our specialties. Our groomer Maddox in particular is known for working with rescue dogs and anxious animals, and clients consistently describe their pets arriving shaking and leaving completely calm and happy. We go at your dog's pace and can accommodate special needs like letting you hold your pet during nail trims.",
  },
  {
    question: "How much does a nail trim cost?",
    answer:
      "Just $5 — and yes, that's real. We do ask that you bring cash for nail trims, so make sure to stop at an ATM beforehand. It's one of the most affordable services in Portland and our staff treats every animal with the same kindness regardless of the service.",
  },
  {
    question: "What should I expect from a full groom?",
    answer:
      "We listen carefully to your styling instructions and deliver a thorough bath, blow-dry, haircut, and finish. Clients describe their dogs coming home 'super soft and cute' and visibly happier after their groom. Results are consistently praised across breed sizes from Chihuahuas to golden retrievers.",
  },
  {
    question: "Are your prices reasonable for Portland?",
    answer:
      "Multiple reviewers have called our pricing 'really reasonable,' 'a great deal,' and 'totally worth it' — especially for the level of skill and care involved. For a full groom on a large breed like a golden retriever, clients consistently say the price-to-quality ratio is excellent. We believe great grooming shouldn't be a luxury.",
  },
  {
    question: "Can I request a specific groomer?",
    answer:
      "Yes, and we encourage it! Clients regularly request Maddox, Ezra, and Amber by name. If you've found a groomer your pet clicks with, just mention their name when you book and we'll do our best to schedule you with them. Building that trust between your pet and their groomer matters to us.",
  },
];
...
const processSteps: ProcessStep[] = [
  {
    ...
    description:
      "Share your dog's quirks, fears, past grooming trauma, and exactly how you want them to look — we actually listen and adjust accordingly.",
  },
  {
    title: "The Calm Begins",
    description:
      "Maddox, Ezra, or Amber takes over with the kind of patient, unhurried energy that even the most reactive pets learn to trust.",
  },
  {
    title: "The Real Work Happens",
    description:
      "A thorough bath, careful dry, breed-appropriate cut, and finish styling — done with attention that shows up in every soft, even stroke.",
  },
  {
    title: "Pick Up a Happy Dog",
    description:
      "You'll walk in expecting your pet to run to you — and find them so relaxed they can barely be bothered, which is exactly the point.",
  },
];
...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "White fluffy dog resting in wire pen with gray mat and collar",
    category: "product",
  },
  {
    src: "/photos/photo-2.webp",
    alt: "Fluffy Pomeranian dog on pink bedding, adorable pet portrait indoors",
    category: "product",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Happy fluffy dog sitting in car back seat with purple harness and toys",
    category: "interior",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "Golden Retriever sitting on wooden floor in home kitchen",
    category: "interior",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Brown dog wearing red collar with tags lying on dark couch",
    category: "product",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Fluffy cream-colored dog standing in cozy living room with brown leather sofa",
    category: "interior",
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div id="faq">
          <FAQAccordion
            heading="Things People Always Ask Us."
            items={faqItems}
          />
        </div>
