...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Professional groomer trimming white dog's nails with scissors in salon",
    category: "work",
  },
  {
    src: "/photos/photo-3.webp",
    alt: "Colorful framed watercolor painting of a smiling corgi dog with vibrant rainbow hues",
    category: "product",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "Professional grooming facility interior with bathing tubs, blue mats, and grooming stations",
    category: "interior",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "White poodle dog indoors with grooming supplies visible in background",
    category: "interior",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Happy golden-brown and white dog smiling at camera on concrete floor indoors",
    category: "interior",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Interior of a fitness studio with exercise equipment and blue mats on floor",
    category: "interior",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Professional groomer styling a black and white poodle at grooming salon",
    category: "work",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "Dog grooming salon window display with three stylized dog portraits and teal lettering",
    category: "interior",
  },
];
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Customers consistently call us one of the best-priced options in the area. We don't charge inflated fees for add-ons like deshedding — you get honest, fair pricing every visit.",
  },
  {
    question: "Can you groom large dogs over 70 pounds?",
    answer:
      "Absolutely. Our groomer Carol specializes in large breeds and has years of experience handling dogs well over 70 pounds — gently and efficiently.",
  },
  {
    question:
      "How do I know what's happening with my dog during their appointment?",
    answer:
      "Our groomers like Carol keep owners updated via text throughout the grooming session, so you're never left wondering. We believe in real communication.",
  },
  {
    question:
      "Do you offer self-serve dog washing, or is it full-service only?",
    answer:
      "Both! We have professional self-serve bathing stations with tubs, hoses, and soap machines that are easy to use and well-maintained — one flat rate for all sizes.",
  },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* ── Services ── */}
      <section id="services" className="dot-pattern py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-12">
            ...
            <p className="mt-3 text-gray-500 max-w-xl mx-auto text-base">
              Full-service grooming, self-serve stations, and everything in
              between — at prices that don't make you wince.
            </p>
          </FadeUp>
          <FadeUp delay={0.15}>
            <ServiceCards
      ...
      <section
        ...
        style={{
          background: `linear-gradient(135deg, ${brand.dark} 0%, #1a3320 100%)`,
          // Override brand vars so nested AboutSection text is readable on dark bg
          ["--brand-text" as never]: "#ffffff",
          ["--brand-muted" as never]: "rgba(255,255,255,0.75)",
          ["--brand-primary" as never]: "#5ee08a",
        }}
      >
        <div className="max-w-6xl mx-auto">
      ...
      <section
        ...
        className="py-20 px-4"
        style={{
          background: `linear-gradient(160deg, #f0fdf4 0%, #e6f7f9 100%)`,
        }}
      >
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-10">
            ...
            <p className="mt-3 text-gray-500 text-base max-w-md mx-auto">
              4.7 stars across 125+ Google reviews. Real words from real Salem
              dog owners.
            </p>
          </FadeUp>
          <FadeUp delay={0.15}>
      ...
      <section
        ...
        style={{
          ...
          // Override brand vars so FAQAccordion text is readable on dark bg
          ["--brand-text" as never]: "#ffffff",
          ["--brand-muted" as never]: "rgba(255,255,255,0.75)",
          ["--brand-primary" as never]: "#5ee08a",
        }}
