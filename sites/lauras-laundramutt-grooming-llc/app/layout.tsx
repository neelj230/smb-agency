...
import { Nunito_Sans, Inter, JetBrains_Mono } from "next/font/google";
...
export const metadata: Metadata = {
  ...
  description:
    "Laura's Laundramutt Grooming LLC is a pet groomer located in Salem, OR. Fresh Pups, Happy Tails, Real People.",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${nunito_sans.variable} ${inter.variable} ${mono.variable}`}
    >
      <head>
