...
const services: Service[] = [
  {
    ...
    description:
      "Full structural and cosmetic repair after accidents, including door panels, body panels, and frame work — restored to pre-accident condition or better.",
    icon: "car",
  ...
  },
  {
    ...
    description:
      "Murphy's team works directly with your insurance adjuster to ensure every necessary repair is authorized and completed — no shortcuts, no lowballing.",
    icon: "shield-check",
  ...
  },
  {
    ...
    description:
      "Full interior cleaning and detailing completed alongside repairs, so your car comes back looking and feeling brand new inside and out.",
    icon: "sparkles",
  ...
  },
  {
    ...
    description:
      "Professional paint matching and finish work that makes repaired panels blend seamlessly with the rest of your vehicle.",
    icon: "paintbrush",
  ...
  },
  {
    ...
    description:
      "Window tinting installation and restoration to keep your ride looking sharp after body work or as a standalone service.",
    icon: "sun",
  ...
  },
  {
    ...
    description:
      "Comprehensive mechanical diagnostics and repair for everyday vehicle issues handled by an experienced, trusted crew.",
    icon: "wrench",
...
const team: TeamMember[] = [
  {
    ...
    credentials: [
      "Named personally in multiple 5-star reviews",
      "Known for insurance adjuster advocacy",
      "Praised for customer patience and guidance",
    ],
  },
];
...
const faqItems: FAQItem[] = [
  {
    question:
      "Can you help me deal with my insurance company after an accident?",
    answer:
      "Absolutely. Murphy's team has a strong track record of working directly with insurance adjusters to make sure every repair is properly authorized and completed. One customer noted that without Murphy's diligence in holding the adjuster accountable, the repairs wouldn't have been done right. You don't have to fight that battle alone.",
  },
  {
    question: "How long will my repair take?",
    answer:
      "Multiple customers have praised S. Murphy for completing repairs in a timely fashion. While every job is different depending on parts and damage, the team is transparent about timelines and works efficiently to get you back on the road without unnecessary delays.",
  },
  {
    question: "Will my car be cleaned when I pick it up?",
    answer:
      "Yes — and customers are often surprised by this. S. Murphy's crew regularly returns vehicles cleaned and detailed as part of their process. One customer arrived with a car she described as filthy inside, and picked it up feeling like it was brand new. It's part of how they do business.",
  },
  {
    question:
      "Do you offer any help with rentals or transportation while my car is being repaired?",
    answer:
      "The team goes the extra mile when they can. One customer noted that Mr. Murphy's crew helped her coordinate returning her rental car when her repair was complete. While availability may vary, the team genuinely tries to make the whole experience as smooth as possible.",
  },
  {
    question: "Are your prices fair compared to other shops?",
    answer:
      "Customers consistently note that Mr. Murphy doesn't hit hard with prices — one reviewer specifically mentioned being guided through coverage options without feeling pressured or overcharged. The focus here is honest work at honest prices, backed by a 4.6-star rating across nearly 200 reviews.",
  },
  {
    question: "How did you earn such a loyal customer base?",
    answer:
      "Almost every review at S. Murphy mentions the same things: genuine care, thorough work, and a crew that treats your car like it matters. Customers don't just come back — they send their friends and family. That word-of-mouth trust is built one honest repair at a time.",
  },
];
...
const processSteps: ProcessStep[] = [
  {
    ...
    description:
      "Drop your car off at 5539 Chestnut St — Mr. Murphy will walk you through exactly what happened, what needs to happen, and what to expect, no jargon, no pressure.",
  },
  {
    title: "We Go to the Mat With Your Insurance",
    description:
      "Murphy's team works directly with your adjuster to make sure every necessary repair gets authorized — no lowballing, no missing line items.",
  },
  {
    title: "Structural, Cosmetic, Mechanical — All of It",
    description:
      "From frame work and body panels to paint matching and interior detailing, your car gets a full restoration, not a patch job.",
  },
  {
    title: "You Pick Up a Car That Feels Brand New",
    description:
      "Detailed inside and out, finished to match the original, and returned with the kind of care that makes customers send their family here next.",
  },
];
...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "S. Murphy Auto Repair photo 3",
    category: "work",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "S. Murphy Auto Repair photo 4",
    category: "work",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "S. Murphy Auto Repair photo 5",
    category: "work",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "S. Murphy Auto Repair photo 6",
    category: "work",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "S. Murphy Auto Repair photo 7",
    category: "work",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "S. Murphy Auto Repair photo 8",
    category: "work",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "S. Murphy Auto Repair photo 9",
    category: "work",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "S. Murphy Auto Repair photo 10",
    category: "work",
  },
];
    ...
    <>
      ...
      <main>
        ...
        <div id="faq" className="bg-[var(--brand-bg-alt)]">
          <FAQAccordion
            heading="You Have Questions. Mr. Murphy Has Answers."
            items={faqItems}
          />
        </div>
