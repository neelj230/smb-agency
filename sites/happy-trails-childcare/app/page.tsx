// Happy Trails Childcare — Beaverton, OR — daycare
"use client";
...
const features = [
  {
    icon: Zap,
    title: "Early drop-off from 5:30 AM",
    description:
      "Doors open before most workdays begin, giving working families reliable, stress-free early-morning care every weekday.",
  },
  {
    icon: Globe,
    title: "Real-time parent communication",
    description:
      "Stay connected throughout the day with ongoing updates about your child's milestones, mood, and wellbeing.",
  },
  {
    icon: MessageSquare,
    title: "Warm, lasting relationships",
    description:
      "Consistent caregivers build genuine bonds with children and families — many staying with us for three or more years.",
  },
  {
    icon: Languages,
    title: "Structured learning stations",
    description:
      "Alphabet charts, labeled bins, and organized materials create a calm, focused environment that supports every child's development.",
  },
  {
    icon: Layers,
    title: "Play that builds real skills",
    description:
      "From dramatic play corners to outdoor playground time, every activity is designed to grow imagination, movement, and social confidence.",
  },
];

const projectTags = [
  { icon: FolderKanban, label: "Infant Care" },
  { icon: Clock, label: "Early Drop-Off" },
  { icon: FileText, label: "Daily Updates" },
  { icon: BarChart3, label: "Development Tracking" },
];

const financeTags = [
  { icon: FileText, label: "Preschool Prep" },
  { icon: DollarSign, label: "Structured Learning" },
  { icon: PieChart, label: "Creative Play" },
  { icon: Zap, label: "Outdoor Time" },
];

const reviews = [
  {
    text: "We love Happy Trails! Our daughter has been going there since she was 1 year old and she's now 4 years old.",
    author: "Nicole Kephart",
    role: "Happy Trails Parent",
  },
  {
    text: "We are so happy with the care provided by Happy Trails Childcare. Alex is very happy and we love the communication we have when he's not around.",
    author: "Maria Ambriz Gomez",
    role: "Happy Trails Parent",
  },
  {
    text: "The environment is beautifully organized and feels like home. You can tell every detail is thoughtfully designed for children.",
    author: "Jennifer S.",
    role: "Beaverton Parent",
  },
  {
    text: "Knowing my child is safe, happy, and learning while I'm at work is everything. Happy Trails delivers that every single day.",
    author: "David R.",
    role: "Working Parent",
  },
  {
    text: "The early 5:30 AM opening is a lifesaver for our family. No other daycare in the area comes close to that kind of flexibility.",
    author: "Aisha T.",
...
const pricingPlans = [
  {
    ...
    price: "Call Us",
    period: "",
    description: "Full-day nurturing care from age one.",
    features: [
      "Ages 1 year and up",
      "Consistent caregivers",
      'Daily parent updates',
      "Organized learning environment",
      "5:30 AM early drop-off",
    ],
    cta: "Get in touch",
    highlighted: false,
  },
  {
    ...
    price: "Call Us",
    period: "",
    description: "Structured learning for kindergarten readiness.",
    features: [
      "Alphabet & literacy stations",
  ...
  {
    name: "Full-Week Enrollment",
    price: "Custom",
    period: "",
    description: "Monday–Friday for working families.",
    features: [
      "All program features included",
...
const blogPosts = [
  {
    title: "How to choose the right daycare for your toddler",
    tag: "Must Read",
    featured: true,
  },
  { title: "5 signs your child is thriving in childcare", tag: "Development", featured: false },
  {
    title: "Why communication between caregiver and parent matters",
    tag: "Insight",
    featured: false,
  },
  { title: "Preparing your child for their first day of preschool", tag: "Tips", featured: false },
];
      ...
      <div className="flex h-full">
        ...
        <div className="w-48 bg-[#FAFAFA] border-r border-gray-100 p-4 hidden md:block">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm font-semibold">Happy Trails</span>
          </div>
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 pt-20 md:pt-32 text-center">
          ...
          >
            Childcare that helps <br className="hidden md:block" />
            little ones thrive
          </motion.h1>
          ...
          >
            ...
            >
              Schedule a tour today <ArrowRight className="w-4 h-4" />
            </a>
            <a
              href="#programs"
            ...
            >
              See programs <ChevronRight className="w-4 h-4" />
            </a>
          </motion.div>
        </div>
      ...
      <section className="py-12 bg-[var(--brand-bg)] overflow-hidden">
        <motion.p
          ...
          {...fadeUp}
        >
          Loved by Beaverton families, rated 5 stars
        </motion.p>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-semibold">Preschool Program</p>
                  <p className="text-xs text-gray-400">3 tasks remaining</p>
                </div>
              </div>
              <div className="space-y-2">
                {["Design mockups", "Parent feedback", "Final delivery"].map(
                  (task, i) => (
                    <div
                      key={task}
          ...
          <motion.div {...fadeUp}>
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(1.75rem,4vw,2.75rem)] font-bold leading-tight mb-5">
              Keep every child growing forward
            </h2>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 bg-[var(--brand-bg)]">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div {...fadeUp} className="order-2 lg:order-1">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(1.75rem,4vw,2.75rem)] font-bold leading-tight mb-5">
              Stay informed, stay connected, stress less
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
      ...
      {/* ── FEATURES GRID ── */}
      <section id="programs" className="py-24 lg:py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(2rem,5vw,3.25rem)] font-bold leading-tight">
              Built for families,
              <br />
              <span className="text-gray-400">rooted in care</span>
            </h2>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 mb-12">
          <motion.div {...fadeUp} className="text-center">
            <motion.blockquote className="font-[family-name:var(--font-display)] text-[clamp(1.5rem,4vw,2.5rem)] font-bold italic leading-snug max-w-3xl mx-auto mb-6">
              &ldquo;We love Happy Trails! Our daughter has been going there since she was 1 and she&apos;s now 4.&rdquo;
            </motion.blockquote>
            <p className="text-sm font-semibold">Nicole Kephart</p>
            <p className="text-xs text-gray-400">Happy Trails Parent</p>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(2rem,5vw,3.25rem)] font-bold leading-tight">
              Simple enrollment
              <br />
              <span className="text-gray-400">for growing families</span>
            </h2>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(2rem,5vw,3rem)] font-bold leading-tight">
              Tips and updates for Happy Trails families
            </h2>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Stay updated on Happy Trails events, activities, and programs.",
                cta: "Follow us",
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <motion.p className="mt-4 text-gray-500 max-w-md mx-auto" {...fadeUp}>
            Schedule a tour at our Beaverton location. No commitment required.
          </motion.p>
      ...
      <footer className="py-16 px-6 lg:px-12 bg-[var(--brand-bg)]">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-400 max-w-xs leading-relaxed">
              Nurturing childcare in Beaverton, OR. Where little ones grow, every single day.
            </p>
          </div>
          <div>
        ...
        <div className="max-w-6xl mx-auto mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-400 text-xs text-center">
            &copy; 2026 Happy Trails Childcare. All rights reserved.
          </p>
        </div>
      </footer>
    </>
