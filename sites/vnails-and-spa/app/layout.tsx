...
export const metadata: Metadata = {
  ...
  description:
    "Nail art, luxury pedicures & more in West Philadelphia. VNails and Spa on Walnut St — where great work and warm service meet. (215) 852-9475",
  keywords: [
    "nail salon Philadelphia",
    "luxury pedicure West Philadelphia",
    "acrylic nails Walnut Street",
    "nail art Philadelphia",
    "dip powder manicure Philadelphia",
    "eyebrow waxing Philadelphia",
    "VNails and Spa",
  ],
  openGraph: {
