...
const services: Service[] = [
  {
    ...
    description: 'A deeply relaxing, multi-step pedicure treatment that leaves feet soft, refreshed, and thoroughly pampered — the salon\'s most talked-about service.',
    icon: 'sparkles',
    image: '/photos/photo-3.webp',
  },
  {
    name: 'Spa Pedicure',
    description: 'A classic spa-level pedicure combining exfoliation, massage, and nail care for a complete foot refresh at an approachable price point.',
    icon: 'droplets',
    image: '/photos/photo-4.webp',
  },
  {
    name: 'Full Set Acrylics',
    description: 'Custom acrylic nail extensions shaped and styled to your preference — from short almonds to dramatic lengths — with optional nail art and designs.',
    icon: 'wand-2',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Nail Art & Custom Designs',
    description: 'Freehand and detailed nail art created by skilled technicians whose work routinely draws compliments from strangers.',
    icon: 'palette',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'Dip Powder Manicure',
    description: 'A durable, lightweight manicure using dip powder for long-lasting color and a natural nail feel without the need for UV curing.',
    icon: 'layers',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Eyebrow & Facial Waxing',
    description: 'Precise eyebrow shaping and facial waxing services available as an add-on to any nail or pedicure appointment.',
    icon: 'scissors',
...
const faqItems: FAQItem[] = [
  {
    question: 'What makes VNails and Spa different from other nail salons in Philadelphia?',
    answer: 'Customers consistently highlight three things: the quality of the nail art (neat, creative, and stylish enough to earn unsolicited compliments), the cleanliness and calming atmosphere of the salon, and the warmth of the staff — particularly Annie, who is known for being gentle, efficient, and genuinely accountable. It\'s a salon where first-timers often leave feeling like regulars.',
  },
  {
    question: 'Do the prices on the menu match what I\'ll actually pay?',
    answer: 'The salon offers a range of service tiers — including spa and luxury pedicure options — and pricing can vary depending on the specific service level you receive. To avoid surprises, we recommend confirming the exact service and price with your technician before they begin. Don\'t hesitate to ask — the team is welcoming and happy to walk you through your options.',
  },
  {
    question: 'How long does a luxury pedicure take, and is it worth it?',
    answer: 'The luxury pedicure is one of the salon\'s most praised services, with clients describing it as \'heavenly\' and noting their feet feel noticeably soft and refreshed afterward. It runs longer than a basic pedicure and is priced accordingly — plan for a relaxed visit rather than a quick in-and-out, and most clients say it\'s absolutely worth it.',
  },
  {
    question: 'What should I do if I\'m not satisfied with my service?',
    answer: 'VNails and Spa stands behind their work. At least one reviewer specifically noted that Annie fixed a pedicure issue the day after the original appointment with no fuss. If something isn\'t right, reach out to the salon directly — the team has demonstrated a real willingness to make things right.',
  },
  {
    question: 'Do you offer nail art and custom designs?',
    answer: 'Yes — nail art is one of the salon\'s standout offerings. Technicians create detailed, custom designs that clients describe as turning out \'even better than imagined.\' Whether you want something subtle like a small heart detail or something more elaborate, the team has the skill to deliver.',
  },
  {
    question: 'Are walk-ins welcome, or should I book an appointment?',
    answer: 'VNails and Spa is open Monday through Friday from 9:30 AM to 6:30 PM and Saturday from 9:00 AM to 4:00 PM (closed Sundays). To guarantee your preferred technician and service time, calling ahead at (215) 852-9475 is recommended — especially on Saturdays, which tend to be busier with the shorter hours.',
  },
]
...
const processSteps: ProcessStep[] = [
  {
    ...
    description: 'Walk in with a vibe, a reference photo, or just a feeling — we\'ll help you shape it into something real.',
  },
  {
    title: 'Settle Into the Space',
    description: 'The salon is clean, bright, and deliberately calming — designed to make the stress of your day quietly disappear.',
  },
  {
    title: 'Let the Experts Work',
    description: 'From freehand nail art to the luxury pedicure people keep raving about, our technicians bring skill and genuine care to every service.',
  },
  {
    title: 'Leave Looking Like You Planned It All Along',
    description: 'Walk out refreshed, polished, and ready for the compliments that are already on their way.',
  },
]
...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: 'VNails and Spa photo 3', category: 'work' },
  { src: '/photos/photo-4.webp', alt: 'VNails and Spa photo 4', category: 'work' },
  { src: '/photos/photo-5.webp', alt: 'VNails and Spa photo 5', category: 'work' },
  { src: '/photos/photo-6.webp', alt: 'VNails and Spa photo 6', category: 'work' },
  { src: '/photos/photo-7.webp', alt: 'VNails and Spa photo 7', category: 'work' },
  { src: '/photos/photo-8.webp', alt: 'VNails and Spa photo 8', category: 'work' },
  { src: '/photos/photo-9.webp', alt: 'VNails and Spa photo 9', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'VNails and Spa photo 10', category: 'work' },
]
