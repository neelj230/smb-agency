...
const faqItems: FAQItem[] = [
  ...
  {
    question: 'What is the typical turnaround time for alterations or cleaning?',
    answer:
...
function ServiceIntroBlock() {
  ...
  return (
    <div className="service-intro-block" ref={ref}>
      ...
      >
        From a Zegna shoulder seam to a Kleinfeld hem — every garment gets the same obsessive attention.
      </motion.p>
    </div>
  )
}
