...
const services: Service[] = [
  {
    ...
    description:
      "Bespoke arrangements designed from scratch based on your vision, occasion, and seasonal availability — no catalogue required.",
    icon: "flower-2",
  ...
  },
  {
    ...
    description:
      "Festive centerpieces and bouquets crafted with seasonal foliage and blooms for holidays like Thanksgiving, Christmas, and more.",
    icon: "leaf",
  ...
  },
  {
    ...
    description:
      "Thoughtfully prepared bouquets to honor and remember loved ones, delivered with sensitivity and consistent care.",
    icon: "heart",
  ...
  },
  {
    ...
    description:
      "No appointment needed — walk in and leave with a stunning custom arrangement created on the spot by our skilled florists.",
    icon: "clock",
  ...
  },
  {
    ...
    description:
      "A curated selection of healthy, affordable plants perfect for gifting or adding greenery to your home or office.",
    icon: "sprout",
  ...
  },
  {
    ...
    description:
      "Not sure what to get? Our team helps you find the perfect floral gift for any recipient, relationship, or occasion.",
    icon: "gift",
...
const team: TeamMember[] = [
  ...
  },
  {
    ...
    credentials: [
      "On-the-Spot Arrangement Specialist",
      "Customer Experience Favorite",
    ],
  },
];
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Absolutely. Mrs. Regan and her team specialize in going beyond the catalogue. Just describe your occasion, preference, or feeling — they'll select the right flowers and foliage and design something unique just for you, often right on the spot.",
  },
  {
    question: "Do you accept walk-ins, or do I need to call ahead?",
    answer:
      "Walk-ins are warmly welcomed! Specialist Sylvina has been praised for accommodating walk-in customers and creating stunning arrangements immediately, without any prior notice needed.",
  },
  {
    question: "Do you offer memorial or sympathy flowers?",
    answer:
      "Yes. Regan's has a long tradition of preparing beautiful, respectful bouquets for memorial purposes. Several customers have relied on the shop for years to honor deceased loved ones with care and consistency.",
  },
  {
    question: "Do you sell individual plants as well as cut flowers?",
    answer:
      "Yes! The shop carries a variety of healthy plants at affordable prices, making them a great option for gifting or home décor. The team can help you find the right plant for any person or space.",
  },
  {
    question: "What are your hours and is the shop open on weekends?",
    answer:
      "Regan's Flower Shop is open Monday through Saturday from 11:00 AM to 6:00 PM. The shop is closed on Sundays. You can also reach them by phone at (215) 879-3810.",
  },
  {
    question: "What makes Regan's different from other Philadelphia florists?",
    answer:
      "The personal touch. Customers consistently describe Mrs. Regan and her team as attentive, warm, and genuinely talented — not just processing orders, but truly listening and creating. The shop has been a trusted community institution for decades, with a perfect 5-star rating to show for it.",
  },
];
...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Regan's Flower Shop photo 3",
    category: "work",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "Regan's Flower Shop photo 4",
    category: "work",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Regan's Flower Shop photo 5",
    category: "work",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "Regan's Flower Shop photo 6",
    category: "work",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Regan's Flower Shop photo 7",
    category: "work",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Regan's Flower Shop photo 8",
    category: "work",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Regan's Flower Shop photo 9",
    category: "work",
  },
];
