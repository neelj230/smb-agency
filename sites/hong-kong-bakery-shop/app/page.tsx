...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Hong Kong Bakery Shop photo 3",
    category: "work",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "Hong Kong Bakery Shop photo 4",
    category: "work",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Hong Kong Bakery Shop photo 5",
    category: "work",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "Hong Kong Bakery Shop photo 6",
    category: "work",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Hong Kong Bakery Shop photo 7",
    category: "work",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Hong Kong Bakery Shop photo 8",
    category: "work",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Hong Kong Bakery Shop photo 9",
    category: "work",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "Hong Kong Bakery Shop photo 10",
    category: "work",
  },
];
...
const services: Service[] = [
  {
    ...
    description:
      "Classic Chinese bakery buns including char siu (BBQ pork) and red bean varieties, baked fresh and sold for around $2 each.",
    icon: "cookie",
  ...
  },
  {
    name: "Egg Tarts",
    description:
      "Traditional Hong Kong egg custard tarts with a flaky pastry shell, a beloved Chinatown staple available daily.",
    icon: "sun",
  ...
  },
  {
    ...
    description:
      "Handmade mochi filled with coconut and peanut — described by customers as phenomenal and generously sized.",
    icon: "star",
  ...
  },
  {
    ...
    description:
      "One of the only Chinatown bakeries open until 2–3 AM, serving fresh baked goods to night owls and late-shift workers.",
    icon: "moon",
  ...
  },
  {
    ...
    description:
      "Soft steamed bao with various savory and sweet fillings, reflecting traditional Hong Kong dim sum bakery traditions.",
    icon: "zap",
  ...
  },
  {
    ...
    description:
      "A rotating selection of fresh Chinese pastries and breads available from early morning through late night every day of the week.",
    icon: "coffee",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Yes, really! We're open Monday through Thursday 7 AM to 2 AM, Friday and Saturday 7 AM to 3 AM, and Sunday 7:30 AM to 2 AM.",
  },
  {
    question: "What's the most popular item to try?",
    answer:
      "Customers rave about our mochi filled with coconut and peanut — one reviewer called it 'phenomenal and huge.' Our egg tarts are also a beloved Chinatown staple.",
  },
  {
    question: "Is the food quality consistent, and are the buns fresh?",
    answer:
      "We bake throughout the day, but like any small bakery, freshness can vary by visit and time of day. Some customers have noted that buns are best enjoyed right after a fresh batch.",
  },
  {
    question: "Is this an authentic Hong Kong-style bakery?",
    answer:
      "Absolutely. We're an immigrant-owned shop rooted in Hong Kong baking traditions, from egg tarts and red bean buns to mochi and steamed bao.",
  },
];
    ...
    <>
      ...
      <section id="services" className="hkb-services-wrap dot-pattern">
        ...
        >
          ...
          <p className="hkb-section-sub">
            From dawn until the small hours — classic Hong Kong flavors at
            Chinatown prices.
          </p>
        </motion.div>
        <motion.div
      ...
      <section id="reviews" className="hkb-reviews-dark">
        ...
        >
          ...
          <h2 className="hkb-section-title" style={{ color: "#fff" }}>
            What People Say
          </h2>
          <p
            className="hkb-section-sub"
            style={{ color: "rgba(255,255,255,0.6)" }}
          >
            Unfiltered Google reviews — the good and the honest.
          </p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
      ...
      <section id="contact" className="hkb-contact-wrap">
        ...
        >
          ...
          <p className="hkb-section-sub">
            917 Race St in Philly's Chinatown. Walk-ins always welcome.
          </p>
        </motion.div>
