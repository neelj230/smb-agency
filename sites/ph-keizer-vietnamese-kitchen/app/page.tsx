...
const services: Service[] = [
  {
    ...
    description: 'Hand-crafted pho in rich, slow-simmered broth served with rice noodles, rare beef or tofu, fresh herbs, and housemade chili oil on the side.',
    icon: 'soup',
    image: '/photos/photo-2.webp',
  },
  {
    name: 'Banh Mi Sandwiches',
    description: 'Vietnamese pressed sandwiches served on crispy-exterior, soft-interior rolls with your choice of protein, pickled carrots, cucumbers, and fresh garnishes.',
    icon: 'sandwich',
    image: '/photos/photo-3.webp',
  },
  {
    name: 'Vermicelli & Noodle Bowls',
    description: 'Hearty noodle bowls featuring charcoal-grilled pork, egg noodles with shrimp, or wonton noodle soup with soft, broth-poached wontons.',
    icon: 'utensils',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Vietnamese Appetizers',
    description: 'Starters including crispy vegetable egg rolls, golden fried calamari with bell peppers, and garlic wings — all praised for bold flavor and beautiful presentation.',
    icon: 'star',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'Specialty Drinks & Vietnamese Coffee',
    description: 'A curated drinks menu featuring Vietnamese iced coffee, fresh pineapple tea, and other house beverages that customers consistently single out as must-orders.',
    icon: 'coffee',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Dine-In Experience',
    description: 'A fully renovated modern dining room with booth seating, floor-to-ceiling windows, and an open ceiling design — an immaculate space built for leisurely lunches and family dinners.',
    icon: 'building-2',
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'Absolutely. The vegan tofu pho is one of the most celebrated items on the menu — regulars like Vin Thomas call it \'the best\' and rave about how fresh it tastes. The vegetable egg rolls are another favorite for plant-based diners.',
  },
  {
    question: 'What should I order if it\'s my first visit?',
    answer: 'The signature beef pho is the anchor of the menu and a must-try. First-timers also love the banh mi sandwich, the charcoal-grilled pork vermicelli bowl, and any of the specialty drinks — especially the Vietnamese iced coffee or the pineapple tea.',
  },
  {
    question: 'How busy does it get, and should I expect a wait?',
    answer: 'Phở Keizer can get quite busy, especially on Saturday afternoons. Juliana Justman noted a longer wait on a crowded weekend visit. Arriving early or during off-peak lunch hours will help you get seated and served more quickly.',
  },
  {
    question: 'Where is the restaurant located, and has it moved recently?',
    answer: 'The current location is at 4998 River Rd N, Keizer, OR 97303. The restaurant recently moved into a beautifully renovated former Shari\'s building — customers describe it as immaculate, with modern décor, booth seating, and floor-to-ceiling windows.',
  },
  {
    question: 'What makes the pho here different from other Vietnamese restaurants?',
    answer: 'Customers consistently point to the authenticity and freshness of the broth, the charcoal-grilled proteins, the quality of the bread used for banh mi, and small touches like housemade chili oil. Damian Sheetz noted it \'tastes authentic\' and was genuinely surprised by the charcoal-grilled preparation.',
  },
  {
    question: 'What are the hours, and are you open on Sundays?',
    answer: 'Phở Keizer is open Monday through Saturday from 11:00 AM to 8:30 PM. The restaurant is currently closed on Sundays, so plan your visit accordingly.',
  },
]
...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-2.webp', alt: 'Bowl of beef pho with rice noodles, broth, and green onion garnish', category: 'food' },
  { src: '/photos/photo-3.webp', alt: 'Bowl of pho with rare beef, noodles, broth, fresh herbs, and onions', category: 'food' },
  { src: '/photos/photo-5.webp', alt: 'Plated Asian dish with beef, crispy noodles, vegetables, and green onions garnish', category: 'food' },
  { src: '/photos/photo-6.webp', alt: 'Modern restaurant interior with booth seating, counter, and open ceiling design.', category: 'interior' },
  { src: '/photos/photo-7.webp', alt: 'Golden fried calamari with red and green bell peppers on white plate', category: 'food' },
  { src: '/photos/photo-8.webp', alt: 'Modern holiday-decorated office reception area with tile walls and wooden desk', category: 'interior' },
  { src: '/photos/photo-9.webp', alt: 'Modern hotel lobby with reception desk, holiday decorations, and elegant furnishings', category: 'interior' },
  { src: '/photos/photo-10.webp', alt: 'Modern restaurant interior with wooden tables, chairs, and floor-to-ceiling windows overlooking street', category: 'interior' },
]
        ...
        <div id="founder">
          <FounderQuote
            founder={{
              name: 'Phở Keizer Vietnamese Kitchen',
              role: 'Owner',
              quote: 'No single founder name surfaces in the reviews, but the identity of Phở Keizer Vietnamese Kitchen is written clearly in every bowl that leaves the kitchen. Someone made the decision to charcoal-grill the pork rather than pan-cook it. Someone sourced the right bread rolls — the kind with a shatteringly crisp crust and pillowy interior that define a proper banh mi. Someone chose to put the wontons in the soup rather than on the side. These are not accidents; they are the choices of a kitchen led by people who grew up with this food and refuse to compromise it for convenience.\n\nWhen the business outgrew its original location and moved into a renovated Shari\'s building on River Road North, they didn\'t just expand square footage — they rebuilt the experience from the ground up, with modern finishes, thoughtful lighting, and a dining room worthy of the food being served inside it. The result is a restaurant that feels like a community investment, a place where stepmothers and stepsons share lunch and make memories, where vegans find a tofu pho that genuinely satisfies, and where first-timers are converted into advocates who bring everyone they know.',
            }}
          />
        </div>

        <div id="faq" className="bg-[var(--brand-bg-alt)]">
          <FAQAccordion heading="Before You Ask, We've Got You" items={faqItems} />
        </div>
