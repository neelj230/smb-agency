...
export const metadata: Metadata = {
  ...
  description:
    "Eugene Heating and Air Conditioning is a hvac contractor located in Eugene, OR. Cool Homes, Fast Fixes, Zero Mess.",
  keywords: [
    "hvac contractor",
    "Eugene",
    "OR",
    "Eugene Heating and Air Conditioning",
  ],
  openGraph: {
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${source_serif_4.variable} ${inter.variable} ${mono.variable}`}
    >
      <head>
