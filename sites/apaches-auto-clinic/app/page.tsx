...
const processSteps: ProcessStep[] = [
  {
    title: "Drop It Off",
    description:
      "Bring your vehicle in — walk-ins welcome. Same-day service available for most jobs.",
  },
  {
    title: "We Diagnose",
    description:
      "A technician inspects and explains the issue in plain language. You'll see exactly what's wrong before anything is touched.",
  },
  {
    title: "Fair Quote",
    description:
      "You get an honest price upfront. No hidden fees, no upsells. Just what your car actually needs.",
  },
  {
    title: "Back on the Road",
    description:
      "Work is completed with quality parts. We stand behind every repair we make.",
  },
];
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Multiple customers describe Apache's pricing as 'super fair' and consistent with or better than competitors in the area.",
  },
  {
    question: "What happens if something is missed during my repair?",
    answer:
      "Apache's stands behind their work. One customer noticed an issue after leaving and returned immediately — the team corrected it without question.",
  },
  {
    question:
      "Will the technician explain what's wrong with my car in plain language?",
    answer:
      "Yes — Brandon in particular has been praised for walking customers through exactly what the problem is, showing them the failed part and why it needed service.",
  },
  {
    question: "Do you take walk-ins or do I need an appointment?",
    answer:
      "Apache's is known for accommodating customers with quick turnaround, including same-day service for straightforward jobs. Walk-ins are welcome.",
  },
];
    ...
    <>
      ...
      <main>
        ...
        <div className="apache-dark-band" id="process">
          <div className="apache-section-label apache-section-label--light">
            How It Works
          </div>
          <ProcessSteps
            heading="The Process"
        ...
        <section
          id="about"
          className="apache-section apache-section--off-white"
        >
        ...
        <div className="apache-dark-band apache-dark-band--accent" id="faq">
          ...
          <FAQAccordion heading="FAQ" items={faqItems} />
        </div>
