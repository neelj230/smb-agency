...
const services: Service[] = [
  {
    ...
    description:
      "Consistent, scheduled weekly cleaning that keeps your home spotless without you lifting a finger — the same reliable team every visit.",
    icon: "calendar-check",
  },
  {
    name: "Deep Home Cleaning",
    description:
      "A thorough, top-to-bottom clean covering every room with meticulous attention to detail, ideal for first-time clients or seasonal refreshes.",
    icon: "sparkles",
  },
  {
    name: "Home Organization & Tidying",
    description:
      "Beyond cleaning, the team helps reorganize cluttered spaces to make your home feel truly ordered and functional — often offered at no extra charge.",
    icon: "layout-grid",
  },
  {
    name: "Move-In / Move-Out Cleaning",
    description:
      "Complete cleaning of a property before you arrive or after you leave, ensuring every surface is fresh and ready for the next chapter.",
    icon: "door-open",
  },
  {
    name: "Custom Cleaning Consultation",
    description:
      "A walkthrough of your home to understand its specific needs before any cleaning begins — because every house is different and deserves a tailored approach.",
    icon: "clipboard-list",
  },
  {
    name: "One-Time Cleaning",
    description:
      "A flexible, no-commitment single clean for guests, special occasions, or whenever life gets ahead of you and you need a reliable reset.",
    icon: "check-circle",
  },
];
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Sam and Junior, the founders of Top Tier Philly Cleaning, personally handle the majority of cleans. You're not getting a rotating roster of strangers — you're getting the same trusted team who knows your home and your preferences.",
  },
  {
    question: "How do I know I can trust someone in my home?",
    answer:
      "Multiple clients, including a military veteran, have specifically praised Sam and Junior as trustworthy, honest, and respectful. One client left for breakfast mid-clean and came home to a spotless house. That level of trust is something they've earned — review by review.",
  },
  {
    question: "What does a typical cleaning include?",
    answer:
      "Top Tier handles thorough cleaning of every room in your home with attention to detail in each space. They also offer light reorganization as needed, going above and beyond what most cleaning services include in a standard visit.",
  },
  {
    question: "How quickly can you schedule a cleaning?",
    answer:
      "Very quickly. Andrew Bogert had a home tour and estimate on Wednesday and was scheduled for a cleaning by Friday morning at 8:30 AM. Same-week scheduling is often available.",
  },
  {
    question: "Is the pricing reasonable for the quality?",
    answer:
      "Multiple reviewers specifically called out the pricing as 'very reasonable' and an 'excellent value' for the quality of work delivered. You get a meticulous, professional clean without premium agency pricing.",
  },
  {
    question: "Do you offer recurring cleaning services?",
    answer:
      "Yes — weekly recurring cleaning is one of their most popular services. Clients like Sedef Paquette have used them on a weekly basis and report that the quality is consistently excellent every single visit.",
  },
];
