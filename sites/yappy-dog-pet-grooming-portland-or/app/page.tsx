...
export default function HomePage() {
  return (
    <>
      <Navbar
        businessName="Yappy Dog Pet Grooming - Portland OR"
        links={navLinks}
        ctaText="Call Now"
        ctaHref="tel:(503) 477-4347"
      />
      ...
      <main>
        ...
        <div id="reviews">
          <TestimonialCarousel
            heading="Straight From the Dog Park"
            reviews={reviews}
            variant="scroll"
          />
        </div>
        ...
        <div id="services" className="bg-[var(--brand-bg-alt)]">
          <ServiceCards
            heading="From Matted Disaster to Show-Ready"
            subheading="Full grooms, lion cuts, nail trims, coat rescues — no judgment, only results."
            services={services}
            columns={3}
            variant="grid"
          />
        ...
        <div id="about">
          <AboutSection
            heading="A Family Shop With a Real Reputation"
            story="Yappy Dog Pet Grooming on SW Beaverton Hillsdale Highway is the kind of place Portland dog owners discover through word of mouth at the dog park and never stop talking about. Groomers Monica and Sharon run a tight, loving operation where the very first appointment feels like a reunion — Monica asks the right questions upfront and tells you exactly what to expect, while Sharon and her family treat every pup as their own. The result? Dogs who come back wagging, not trembling. As one longtime customer put it, when she picks up her girls after a session, 'they don't come out with shell shock' — and in a world of rushed, impersonal grooming chains, that matters enormously.  The clientele at Yappy Dog runs the full spectrum: Scout the chill Shih Tzu enjoying his spa day, two tiny neurotic fluffballs getting precision lion cuts, and matted, DIY-haircut-disaster dogs arriving in 'embarrassingly bad condition' and leaving looking show-ready. No judgment, only results. The team handles last-minute bookings with grace, accommodates anxious and wriggly dogs with patience, and consistently delivers quality that keeps customers driving back across Portland. At roughly $90 per full haircut and nail trim for small breeds, it's a fair price for a genuinely caring experience.  With a 4.6-star rating built on 73 reviews — nearly all of them enthusiastic word-of-mouth referrals — Yappy Dog has quietly become one of Southwest Portland's most trusted grooming spots. It's a family business with real personality: the kind of place where the staff remembers your dog's name, asks the right questions, and sends them home looking better than you imagined."
            image={aboutImage}
          />
        </div>
        ...
        <div id="process" className="bg-[var(--brand-bg-alt)]">
          <ProcessSteps
            heading="What Happens Between Drop-Off and That Reveal Moment"
            subheading="No surprises. Just a clean, calm process designed for you and your dog."
            steps={processSteps}
            variant="timeline"
          />
        </div>
        ...
        <div id="gallery">
          <ImageGallery
            heading="Before the Bow Goes On"
        ...
        <div id="contact" className="bg-[var(--brand-bg-alt)]">
          <ContactSection
            ...
            heading="Come Find Us on Beaverton Hillsdale"
            showMap={false}
          />
        </div>
      </main>
