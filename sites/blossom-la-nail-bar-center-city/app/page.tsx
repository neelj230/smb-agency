...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: 'Blossom LA Nail Bar Center City photo 3', category: 'work' },
  { src: '/photos/photo-4.webp', alt: 'Blossom LA Nail Bar Center City photo 4', category: 'work' },
  { src: '/photos/photo-5.webp', alt: 'Blossom LA Nail Bar Center City photo 5', category: 'work' },
  { src: '/photos/photo-6.webp', alt: 'Blossom LA Nail Bar Center City photo 6', category: 'work' },
  { src: '/photos/photo-7.webp', alt: 'Blossom LA Nail Bar Center City photo 7', category: 'work' },
  { src: '/photos/photo-8.webp', alt: 'Blossom LA Nail Bar Center City photo 8', category: 'work' },
  { src: '/photos/photo-9.webp', alt: 'Blossom LA Nail Bar Center City photo 9', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'Blossom LA Nail Bar Center City photo 10', category: 'work' },
]

const services: Service[] = [
  {
    name: 'Gel Manicure',
    description: "Long-lasting gel color applied with care — reviewers note clean results that don't cost an arm and a leg, with strong natural nails underneath.",
    icon: 'sparkles',
    image: '/photos/photo-3.webp',
  },
  {
    name: 'Gel X Extensions',
    description: 'Full nail extensions using Gel X technique, ideal for length and custom nail art — Arielle is a client favorite for first-timers and regulars alike.',
    icon: 'wand-2',
    image: '/photos/photo-4.webp',
  },
  {
    name: 'Custom Nail Art',
    description: 'Intricate, design-forward nail art — from Lunar New Year themes to reference-photo-matched sets — executed with precision and creative input.',
    icon: 'palette',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Spa Pedicure',
    description: 'A relaxing pedicure with focused attention on rough spots others skip, paired with a massage and a thorough, calming experience.',
    icon: 'heart',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'Classic Manicure',
    description: 'A clean, polished manicure with a strong selection of nail polish colors and a soothing massage component to round out your visit.',
    icon: 'scissors',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Nail Strengthening Treatment',
    description: "Targeted care for clients with weak or damaged natural nails — Natalie's clients specifically note improved nail strength over time.",
    icon: 'shield',
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'Appointments are strongly recommended. The salon is popular and walk-ins are welcome, but multiple reviewers noted that booking ahead ensures you get the time slot — and the technician — you want.',
  },
  {
    question: 'Can I request a specific technician like Natalie or Arielle?',
    answer: 'Yes — and regulars highly recommend it. Both Natalie and Arielle have devoted clients who book specifically for them. If you have a preference, mention it when you book.',
  },
  {
    question: 'What makes Blossom LA different from other nail salons in Philly?',
    answer: 'Clients consistently highlight that the staff actually asks what you want and listens — something that sounds basic but is surprisingly rare. The combination of quality work, fair pricing, and a warm atmosphere keeps people coming back for years.',
  },
  {
    question: 'Do you do custom nail art and specialty designs?',
    answer: 'Absolutely. Arielle in particular is celebrated for executing detailed, theme-based nail art — from Lunar New Year designs to exact reference-photo matches. Bring inspiration and expect it to come to life.',
  },
]
      ...
      <div className="blossom-ticker-inner">
        {doubled.map((item, i) => (
          <span key={i} className="blossom-ticker-item">
            {item}
            <span className="blossom-ticker-dot" aria-hidden>✦</span>
          </span>
        ))}
      </div>
    </div>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="blossom-section-label">{children}</span>
  )
}
...
export default function Page() {
  return (
    <>
      ...
      <div
        id="services"
        className="blossom-services-wrapper"
      >
        <motion.div
      ...
      <div
        id="reviews"
        className="blossom-reviews-wrapper"
      >
        <motion.div
          className="blossom-section-label-row"
          initial={{ opacity: 0, y: 20 }}
