...
const services: Service[] = [
  {
    ...
    description:
      "Custom acrylic nail sets starting at competitive neighborhood prices, available in a range of lengths and shapes.",
    icon: "sparkles",
  ...
  },
  {
    name: "Nail Refills",
    description:
      "Acrylic fill-ins to keep your set looking fresh, priced from $17 and up depending on length and condition.",
    icon: "refresh-cw",
  ...
  },
  {
    name: "Gel Polish",
    description:
      "Long-lasting gel color applied over natural or acrylic nails for a chip-resistant, high-shine finish.",
    icon: "droplets",
  ...
  },
  {
    name: "Pedicure",
    description:
      "Foot care service including nail shaping, cuticle work, and polished color for soft, smooth results.",
    icon: "footprints",
  ...
  },
  {
    ...
    description:
      "Precision brow shaping performed by Kim, celebrated by regulars as some of the best in West Philadelphia.",
    icon: "eye",
  ...
  },
  {
    ...
    description:
      "Professional lash application by Kim starting at just $25, delivering salon-quality results at accessible prices.",
    icon: "wand-2",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Tran Nails is a cash-only salon, so be sure to bring cash before your visit. There may be an ATM nearby if you need one.",
  },
  {
    question: "What's the best time to come in to avoid a long wait?",
    answer:
      "Arriving earlier in the day tends to get you in and out faster. One reviewer arrived around 3 PM and was done by 4:15, but mornings right at opening are typically the smoothest.",
  },
  {
    question: "How much does a full set with gel polish cost?",
    answer:
      "A standard full set starts at a base price with gel polish listed from $20 up. Note that longer nail lengths may add to the total — it's worth confirming pricing before the service begins, especially if you have extra-long nails.",
  },
  {
    question: "Who does the eyebrows and lashes, and how much does it cost?",
    answer:
      "Kim is the go-to for both eyebrow shaping and lash services. Lashes start at $25 and reviewers consistently rave about her precision and professionalism. She's one of the most requested staff members in the salon.",
  },
  {
    question: "Are walk-ins welcome or do I need an appointment?",
    answer:
      "Tran Nails operates on a walk-in basis. To get the best experience and shortest wait, arriving early — especially on busy weekday afternoons — is highly recommended by regulars.",
  },
  {
    question: "Is the staff friendly even when it's busy?",
    answer:
      "Across reviews — including those with service complaints — customers consistently praised the staff as very friendly. The welcoming atmosphere is one of the most mentioned qualities of Tran Nails.",
  },
];
...
const processSteps: ProcessStep[] = [
  {
    title: "Pull Up Early",
    description:
      "Walk-ins welcome — arrive before the mid-afternoon rush and you'll be in and out without the wait.",
  },
  {
    title: "Tell Kim What You Want",
    description:
      "Whether it's a full set, a brow shape, or a fresh set of lashes, the team listens before they touch a thing.",
  },
  {
    title: "Watch the Magic Happen",
    description:
      "Skilled hands, a warm room, and a staff that makes you feel like a regular — even if it's your first time.",
  },
  {
    title: "Leave Looking Like Yourself, Only Better",
    description:
      "Chip-resistant, shaped, polished, and done right — so good you'll already be planning your next visit.",
  },
];
