...
export default function HomePage() {
  return (
    <>
      <Navbar
        businessName="Steve’s Old City Cleaners & Tailors"
        links={navLinks}
        ctaText="Call Now"
        ctaHref="tel:(215) 427-2550"
      />
      ...
      <main>
        ...
        <div id="services" className="bg-[var(--brand-bg-alt)]">
          <ServiceCards
            heading="What We'll Do For You"
            subheading="From a custom tux for your wedding to a last-minute hem the night before — Steve handles it all with the same unhurried precision."
            services={services}
            columns={3}
            variant="alternating"
          />
        ...
        <div id="about">
          <AboutSection
            heading="Old City's Best-Kept Open Secret"
            story="Steve's Old City Cleaners & Tailors isn't just a shop on Chestnut Street — it's a living institution. With over 50 years in the craft, Steve has built a reputation in Philadelphia's historic Old City neighborhood that most businesses only dream about. Customers like Greg Becker come in without a clear vision and leave with a custom tux tailored to precision and a genuine education in fit. Ethan Nguyen, who owns a large menswear collection and has struggled with tailors before, calls Steve 'top tier' — not just in skill, but in the rare ability to actually listen. When Hannah Brusca brought in a gown with five layers of fabric needing hemming days before a wedding, Steve didn't flinch — he made sure she could try it on and had it finished on time.  What separates Steve from the average dry-clean-and-hem operation is his instinct for people. Genevieve Nania came in at closing time with a last-minute dress alteration and Steve stayed open, unhurried and welcoming, until the job was done right. That's not policy — that's character. Customers don't just recommend him; they tell their friends, return with entire wardrobes, and admit they'd visit 'just to hang out.' He remembers his clients by name, tracks evolving fashion trends despite decades in the trade, and guides customers through decisions they didn't even know they needed to make.  The shop does carry one honest cautionary note: Steve himself acknowledges that challenging materials like jersey fabric require upfront conversations about realistic outcomes. One customer's experience with a jersey bridesmaid gown hem fell below expectations, and the resolution left her feeling unheard. Steve's strengths shine brightest on structured garments — suits, tuxedos, formal wear — where his precision and experience are virtually unmatched in the city. For those pieces, the 4.8-star rating across over 100 reviews speaks loudly and clearly."
            image={aboutImage}
          />
        </div>
