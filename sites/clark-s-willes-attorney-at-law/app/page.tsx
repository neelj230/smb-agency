...
const features = [
  {
    icon: Shield,
    title: "Measure 11 Felony Defense",
    description:
      "Aggressive representation for mandatory minimum felony charges where conviction means years of mandatory prison time with no early release.",
  },
  {
    icon: Car,
    title: "DUI Defense",
    description:
      "Specialized DUI defense across Benton, Linn, and neighboring counties, with a track record clients describe as unmatched in the region.",
  },
  {
    icon: MessageSquare,
    title: "Criminal Defense Consultation",
    description:
      "Initial case evaluation for individuals facing misdemeanor or felony charges, including honest assessment of options and strategy.",
  },
  {
    icon: Scale,
    title: "Plea Negotiation & Sentencing Advocacy",
    description:
      "Strategic plea bargaining and courtroom advocacy aimed at reducing charges, minimizing sentences, and keeping clients out of custody.",
  },
  {
    icon: FileText,
    title: "Court-Appointed Defense",
    description:
      "Representation for court-assigned clients across Benton County criminal proceedings, applying the same legal expertise as retained cases.",
  },
];

const projectTags = [
  { icon: Shield, label: "Felony Defense" },
  { icon: Gavel, label: "Trial Representation" },
  { icon: FileText, label: "Case Evaluation" },
  { icon: BarChart3, label: "Sentencing Advocacy" },
];

const financeTags = [
  { icon: FileText, label: "Plea Negotiation" },
  { icon: DollarSign, label: "Flexible Fees" },
  { icon: Scale, label: "Court-Appointed" },
  { icon: AlertCircle, label: "Post-Arrest Guidance" },
];

const reviews = [
  {
    text: "Clark Willis is a wonderful attorney. I honestly didn't think I had a chance to beat my felony (measure 11) charges. The man is honestly a legal expert. I highly recommend this man to help you.",
    author: "John Scott",
    role: "Criminal Defense Client",
  },
  {
    text: "The only time Mr. Willis does nothing is when there is nothing he can do. He does try and is/was very effective for me. I've seen over and over different people that are not proactive and not patient.",
    author: "Ern Burgs",
    role: "Criminal Defense Client",
  },
  {
    text: "This is the best DUI attorney in probably multiple counties — for sure Linn County and the neighbors. If you have a DUI and you do not hire this attorney, trust me. He will work with you on finances. He is worth it.",
    author: "Scott Heinz",
    role: "DUI Defense Client",
  },
  {
    text: "He does try and is very effective. I got to stay with my family and be surrounded by love after beating my charges. That outcome doesn't happen by accident — it happens because Clark knows the law cold.",
    author: "Former Client",
    role: "Measure 11 Defense Client",
  },
  {
    text: "Clark worked a really good deal for my case. He understands the courthouse and how to work the system in your favor. Highly recommend for anyone facing serious criminal charges in Benton or Linn County.",
    author: "Local Client",
    role: "Criminal Defense Client",
  },
];
...
const pricingPlans = [
  {
    ...
    price: "Call",
    period: "",
    description: "For individuals needing an initial case review.",
    features: [
      "Case evaluation",
      "Charge assessment",
      "Rights explanation",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "For clients facing serious criminal charges.",
    features: [
      "Felony & DUI defense",
      "Plea negotiation",
      "Courtroom advocacy",
  ...
  },
  {
    ...
    price: "Assigned",
    period: "",
    description: "For court-assigned clients in Benton County.",
    features: [
      "Full legal representation",
      'Case evaluation',
      "Plea negotiation",
      'Courtroom advocacy',
      "Same expertise as retained",
    ],
    cta: "Learn more",
    highlighted: false,
  },
...
const blogPosts = [
  {
    title: "What Measure 11 really means for Oregon defendants",
    tag: "Must Read",
    featured: true,
  },
  { title: "What to do immediately after a DUI arrest in Oregon", tag: "Guidance", featured: false },
  {
    title: "How plea negotiation can change the outcome of your case",
    tag: "Strategy",
    featured: false,
  },
  { title: "Understanding your rights after a felony arrest", tag: "Know Your Rights", featured: false },
];
      ...
      <div className="flex h-full">
        ...
        <div className="w-48 bg-[#FAFAFA] border-r border-gray-100 p-4 hidden md:block">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm font-semibold">Willes Law</span>
          </div>
        ...
        <div className="flex-1 p-4 md:p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-sm font-semibold">Welcome, Client</p>
      ...
      <div className="p-4 bg-white">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-[10px] font-semibold">Welcome, Client</p>
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 pt-20 md:pt-32 text-center">
          ...
          >
            Criminal defense that <br className="hidden md:block" />
          ...
          >
            Corvallis criminal defense attorney. Measure 11 felonies, DUI, and
            serious charges &mdash; when the stakes are highest, Clark fights hardest.
          </motion.p>
          ...
          >
            ...
            >
              See practice areas <ChevronRight className="w-4 h-4" />
            </a>
          </motion.div>
        </div>
      ...
      <section className="py-12 bg-[var(--brand-bg)] overflow-hidden">
        <motion.p
          ...
          {...fadeUp}
        >
          Rated 4.2 stars across 10 client reviews in Corvallis, OR
        </motion.p>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Facing charges in
            <br />
            <span className="text-gray-400">Corvallis or beyond?</span>
          </motion.h2>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-semibold">Case Review</p>
                  <p className="text-xs text-gray-400">3 tasks remaining</p>
                </div>
              </div>
              <div className="space-y-2">
                {["Design mockups", "Client review", "Final delivery"].map(
                  (task, i) => (
                    <div
                      key={task}
          ...
          <motion.div {...fadeUp}>
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(1.75rem,4vw,2.75rem)] font-bold leading-tight mb-5">
              Keep your case moving in the right direction
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
              From initial charge assessment to courtroom advocacy, Clark builds
              a defense strategy tailored to your specific case. Measure 11
              felonies, DUI charges, plea negotiations &mdash; every angle covered.
            </p>
            <a
              href="#contact"
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 bg-[var(--brand-bg)]">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div {...fadeUp} className="order-2 lg:order-1">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(1.75rem,4vw,2.75rem)] font-bold leading-tight mb-5">
              Measure 11, DUI, felony — we handle it
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
              Facing Measure 11 mandatory minimum charges, DUI allegations, or other
              felony charges? Clark will work with you on finances and fight
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-semibold">Case Overview</p>
                  <p className="text-xs text-gray-400">Your defense</p>
                </div>
              </div>
      ...
      {/* ── FEATURES GRID ── */}
      <section id="practice areas" className="py-24 lg:py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(2rem,5vw,3.25rem)] font-bold leading-tight">
              Defense built for
              <br />
              <span className="text-gray-400">the highest stakes</span>
            </h2>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 mb-12">
          <motion.div {...fadeUp} className="text-center">
            <motion.blockquote className="font-[family-name:var(--font-display)] text-[clamp(1.5rem,4vw,2.5rem)] font-bold italic leading-snug max-w-3xl mx-auto mb-6">
              &ldquo;Clark Willis is a wonderful attorney. The man is honestly
              a legal expert. I highly recommend this man to help you.&rdquo;
            </motion.blockquote>
            <p className="text-sm font-semibold">John Scott</p>
            <p className="text-xs text-gray-400">Felony Defense Client</p>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(2rem,5vw,3.25rem)] font-bold leading-tight">
              Honest counsel
              <br />
              <span className="text-gray-400">when it matters most</span>
            </h2>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(2rem,5vw,3rem)] font-bold leading-tight">
              Insights on Oregon criminal law and your rights
            </h2>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Know your rights under Oregon criminal law. Stay informed about Measure 11 and DUI defense.",
                cta: "Follow us",
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <motion.p className="mt-4 text-gray-500 max-w-md mx-auto" {...fadeUp}>
            Call Clark S. Willes today. First consultation is free.
          </motion.p>
      ...
      <footer className="py-16 px-6 lg:px-12 bg-[var(--brand-bg)]">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-400 max-w-xs leading-relaxed">
              Criminal defense attorney serving Corvallis, OR. Measure 11 felonies,
              DUI defense, and serious criminal charges.
            </p>
          </div>
          <div>
        ...
        <div className="max-w-6xl mx-auto mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-400 text-xs text-center">
            &copy; 2026 Clark S. Willes, Attorney at Law. All rights reserved.
          </p>
        </div>
      </footer>
    </>
