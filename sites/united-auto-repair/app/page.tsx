...
const stats: Stat[] = [
  ...
  { value: 178, suffix: "+", label: "Verified Customer Reviews" },
  {
    value: 2,
    suffix: " Generations",
    label: "Of Loyal Neighborhood Customers",
  },
...
const services: Service[] = [
  {
    ...
    description:
      "Full brake system diagnostics and repair including calipers, pads, and rotors — often sourced and fixed in-house to save you dealer prices.",
    icon: "disc",
  ...
  },
  {
    name: "Oil Change",
    description:
      "Fast, same-day oil changes using quality fluids — in and out without an appointment headache.",
    icon: "droplets",
  ...
  },
  {
    ...
    description:
      "Pennsylvania state inspections completed the same day you call, keeping you legal and road-ready.",
  ...
  },
  {
    ...
    description:
      "New tire sourcing and installation with competitive pricing and same-day turnaround.",
    icon: "circle",
  ...
  },
  {
    ...
    description:
      "Diagnosis and repair of wiper fluid dispensing systems and wiper assemblies to restore full visibility.",
    icon: "wind",
  ...
  },
  {
    ...
    description:
      "Honest, thorough vehicle assessments where the team tells you exactly what's needed — and what isn't.",
    icon: "search",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "United Auto Repair is known for same-day service — customers have called in the morning and had their oil change and inspection done that same day. Call ahead at (215) 871-8440 to confirm availability, but walk-ins are welcomed when the schedule allows.",
  },
  {
    question: "Will I be treated fairly as a woman bringing in my car alone?",
    answer:
      "Absolutely. Multiple female customers have specifically called out that they've always been treated with respect and never felt taken advantage of. That's a standard the staff holds consistently — not just occasionally.",
  },
  {
    question: "Are your prices competitive compared to dealerships?",
    answer:
      "Yes — and that's one of the most consistent things customers mention. The team actively works to save you money, including repairing parts in-house rather than sending you to a dealer for an expensive replacement.",
  },
  {
    question: "How fast is the turnaround on common repairs?",
    answer:
      "Most standard services — oil changes, inspections, brake jobs, tire installations — are completed the same day. The shop is known for being fast without cutting corners.",
  },
  {
    question: "What are your hours and do you work on Saturdays?",
    answer:
      "Yes, United Auto Repair is open Saturday 8:00 AM to 3:00 PM, making it accessible for customers who work weekdays. Monday through Friday hours are 8:00 AM to 4:30 PM. The shop is closed Sundays.",
  },
  {
    question: "Is this a shop that's been around long enough to trust?",
    answer:
      "Long enough that some customers are second-generation — their parents brought cars here, and now they do too. That kind of multi-generational loyalty in a neighborhood like West Philadelphia says everything about the shop's consistency and character.",
  },
];
...
const processSteps: ProcessStep[] = [
  {
    ...
    description:
      "No appointment anxiety — reach out same-day and we'll tell you exactly what we can do, right then.",
  },
  {
    title: "Honest Assessment First",
    description:
      "Bishop and the team give you a straight read on your vehicle — what's needed, what isn't, and why.",
  },
  {
    title: "In-House Fixes That Save You Money",
    description:
      "Where most shops send you to the dealer, we source and solve in-house — saving you real dollars on labor and parts.",
  },
  {
    title: "Out the Door the Same Day",
    description:
      "From oil changes to brake calipers to state inspections, we turn it around fast so you get back to your life.",
  },
];
...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "United Auto Repair photo 3",
    category: "work",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "United Auto Repair photo 4",
    category: "work",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "United Auto Repair photo 5",
    category: "work",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "United Auto Repair photo 6",
    category: "work",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "United Auto Repair photo 7",
    category: "work",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "United Auto Repair photo 8",
    category: "work",
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div id="faq">
          <FAQAccordion
            heading="Questions We Actually Hear Every Day"
            items={faqItems}
          />
        </div>
