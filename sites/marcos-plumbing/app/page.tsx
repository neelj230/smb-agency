...
const galleryPhotos: Photo[] = [
  { src: '/photos/bathroom-remodel-1.webp', alt: 'Completed bathroom remodel with subway tile and rainfall shower', category: 'work' },
  { src: '/photos/bathroom-remodel-2.webp', alt: 'Before and after of a full bathroom renovation', category: 'work' },
  { src: '/photos/water-heater-install.webp', alt: 'New Bradford White water heater installation in basement', category: 'work' },
  { src: '/photos/drain-camera.webp', alt: 'Sewer camera inspection in progress', category: 'work' },
  { src: '/photos/boiler-service.webp', alt: 'Boiler maintenance and repair service', category: 'work' },
  { src: '/photos/interior-shop.webp', alt: "Inside the Marco's Plumbing shop and parts inventory", category: 'interior' },
]

const services: Service[] = [
  {
    name: 'Emergency Plumbing',
    description: '24/7 emergency service for burst pipes, major leaks, sewer backups, and no-heat calls. We guarantee a 60-minute response time anywhere in Philadelphia.',
    icon: 'alert-triangle',
    image: '/photos/bathroom-remodel-1.webp',
  },
  {
    name: 'Drain Cleaning',
    description: 'Camera inspection and hydro-jetting for stubborn clogs. Kitchen drains, bathroom drains, main sewer lines. We find the problem before we fix it.',
    icon: 'droplets',
    image: '/photos/bathroom-remodel-2.webp',
  },
  {
    name: 'Water Heater Installation',
    description: 'Tank and tankless water heater installation and repair. We carry Bradford White and Rinnai — the best in the business. Free estimates on all installations.',
    icon: 'flame',
    image: '/photos/water-heater-install.webp',
  },
  {
    name: 'Bathroom Remodeling',
    description: "Full bathroom renovations from demo to tile. We handle the plumbing, coordinate with electricians and tile setters, and manage the whole project so you don't have to.",
    icon: 'bath',
    image: '/photos/drain-camera.webp',
  },
  {
    name: 'Sewer Line Repair',
    description: 'Trenchless sewer repair and replacement. We fix collapsed, cracked, and root-damaged sewer lines without destroying your yard. Camera inspection included.',
    icon: 'construction',
    image: '/photos/boiler-service.webp',
  },
  {
    name: 'Heating & Boiler Service',
    description: 'Boiler installation, repair, and annual maintenance. Radiator bleeding, zone valve replacement, circulator pump service. Keep your Philly row home warm all winter.',
    icon: 'thermometer',
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'Yes. Call our main number any time — nights, weekends, holidays. We guarantee a plumber at your door within 60 minutes anywhere in Philadelphia.',
  },
  {
    question: 'Are you licensed and insured?',
    answer: 'Absolutely. Marco holds a PA Master Plumber License (#MP-032841) and we carry $2M in liability insurance. All of our plumbers are fully licensed and background-checked.',
  },
  {
    question: 'Do you give free estimates?',
    answer: "Yes, for all non-emergency work. We'll come out, assess the job, and give you a detailed written estimate before any work begins. No surprises.",
  },
  {
    question: 'What areas do you serve?',
    answer: 'All of Philadelphia plus the close-in suburbs — Bala Cynwyd, Cheltenham, Darby, Yeadon, Upper Darby, and Drexel Hill. If you\'re not sure, just call us.',
  },
]
...
export default function MarcoPlumbingPage() {
  ...
  return (
    <>
      ...
      <div className="marcos-page" style={{ fontFamily: "'Source Sans 3', sans-serif" }}>
        ...
        {/* ── Scrolling Trust Bar ── */}
        <div className="trust-bar-wrapper" style={{ background: BRAND_BLUE, overflow: 'hidden', padding: '0.85rem 0' }}>
          <div className="trust-bar-track">
            {[...trustItems, ...trustItems].map((item, i) => (
              <span key={i} className="trust-bar-item" style={{ fontFamily: "'Source Sans 3', sans-serif" }}>
                <span className="trust-bar-dot" style={{ color: BRAND_GREEN }}>◆</span>
                {item}
              </span>
            ))}
          </div>
        ...
        {/* ── Divider accent ── */}
        <div style={{ height: 4, background: `linear-gradient(90deg, ${BRAND_BLUE} 0%, ${BRAND_GREEN} 100%)` }} />

        {/* ── Gallery ── */}
        <section
          id="gallery"
          style={{ background: '#0f1923', padding: '5rem 0' }}
        >
          <motion.div
            initial={{ opacity: 0, y: 32 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="emergency-banner dot-pattern" style={{ background: BRAND_BLUE, padding: '4.5rem 1.5rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          >
            ...
            <h2 style={{
              ...
              Pipe burst? Basement flooding?<br />
            ...
            <p style={{
              ...
              We're in South Philly. We'll be there in 60 minutes — nights, weekends, and holidays.
            </p>
            <a
