...
export const metadata: Metadata = {
  ...
  description:
    "Judge Auto Repair Inc is a auto repair located in Philadelphia, PA. Honest Wrenches. Real Prices. No BS.",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${merriweather.variable} ${inter.variable} ${mono.variable}`}
    >
      <head>
