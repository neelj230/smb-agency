...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: 'Judge Auto Repair Inc photo 3', category: 'work' },
  { src: '/photos/photo-4.webp', alt: 'Judge Auto Repair Inc photo 4', category: 'work' },
  { src: '/photos/photo-5.webp', alt: 'Judge Auto Repair Inc photo 5', category: 'work' },
  { src: '/photos/photo-6.webp', alt: 'Judge Auto Repair Inc photo 6', category: 'work' },
  { src: '/photos/photo-7.webp', alt: 'Judge Auto Repair Inc photo 7', category: 'work' },
  { src: '/photos/photo-8.webp', alt: 'Judge Auto Repair Inc photo 8', category: 'work' },
  { src: '/photos/photo-9.webp', alt: 'Judge Auto Repair Inc photo 9', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'Judge Auto Repair Inc photo 10', category: 'work' },
]
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'Yes — multiple customers have specifically noted that Judge Auto\'s prices beat dealership rates by a meaningful margin.',
  },
  {
    question: 'Is the shop open on Saturdays?',
    answer: 'Yes. Judge Auto is open Monday through Saturday, 9:00 AM to 5:30 PM. Saturday availability is a big deal — customers have come in when no other local shop would take them.',
  },
  {
    question: 'Is this a fancy shop with a nice waiting room?',
    answer: 'Honestly, no — and that\'s by design. Judge Auto is a working repair garage, not a customer lounge. The investment goes into the work, not the décor.',
  },
  {
    question: 'Can I choose between new and used parts for my repair?',
    answer: 'Absolutely. Gona will walk you through your options and let you decide whether you want new parts or more budget-friendly quality used parts.',
  },
]
      ...
      <div className="judge-page">
        ...
        >
          {[
            ...
            <motion.div key={item.text} className="trust-pill" variants={fadeUp}>
        ...
        <section className="tagline-break">
          ...
          >
            ...
            <h2 className="tagline-break__headline">
              "IT IS NOT PRETTY.<br />IT'S A REPAIR GARAGE."
            </h2>
