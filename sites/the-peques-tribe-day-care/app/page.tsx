...
const stats: Stat[] = [
  ...
  { value: 8, suffix: " weeks", label: "Youngest Age We Welcome" },
  {
    value: 2,
    suffix: " languages",
    label: "English & Spanish Daily Immersion",
  },
];
...
const services: Service[] = [
  {
    name: "Infant Care",
    description:
      "Specialized one-on-one care for babies as young as eight weeks, including tummy time, sensory play, safe sleep practices, and feeding tracking via parent app.",
    icon: "baby",
  ...
  },
  {
    ...
    description:
      "A structured yet playful daily program focused on motor skill development, educational play, and age-appropriate activities in a bright, stimulating classroom environment.",
    icon: "blocks",
  ...
  },
  {
    ...
    description:
      "Daily Spanish language exposure woven naturally into routines, songs, and conversation — giving children an early bilingual foundation regardless of their home language.",
    icon: "languages",
  ...
  },
  {
    ...
    description:
      "Nutritious, child-friendly meals served daily in a colorful dining space, supporting children's energy, focus, and overall well-being throughout the day.",
    icon: "apple",
  ...
  },
  {
    ...
    description:
      "Daily outdoor time in a secure backyard featuring playground equipment, a shaded pergola, and open space for active, joyful play in the fresh air.",
    icon: "trees",
  ...
  },
  {
    ...
    description:
      "Real-time updates on feedings, diaper changes, naps, and daily activities — plus photo uploads — so parents stay connected and confident throughout the day.",
    icon: "smartphone",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "We accept infants as young as eight weeks old. Sabrina has extensive experience with newborn and infant care, including tummy time routines, sensory play, and strict safe sleeping protocols during nap time.",
  },
  {
    question: "How will I know what my child did during the day?",
    answer:
      "We use a parent communication app that logs every feeding, diaper change, and nap in real time. Sabrina also uploads photos of activities throughout the day so you feel connected even when you're at work.",
  },
  {
    question: "Is this a large daycare center or a small home setting?",
    answer:
      "The Peques Tribe is intentionally small — a warm, home-based daycare designed for personalized, one-on-one attention. Parents consistently praise the intimate environment as one of our biggest strengths.",
  },
  {
    question: "Do you offer Spanish immersion?",
    answer:
      "Yes! Spanish is woven naturally into our daily routines, conversations, and activities. This is a wonderful benefit even for English-speaking families — children absorb a second language effortlessly at this age.",
  },
  {
    question: "Are meals provided, and are they healthy?",
    answer:
      "Yes, we provide healthy meals and snacks each day. Families appreciate knowing their children are eating well without any extra preparation on busy mornings.",
  },
  {
    question: "What does a typical day look like for the children?",
    answer:
      "Days at The Peques Tribe include structured learning activities, sensory and motor skill play, outdoor time in our backyard playground, meals, and plenty of creative play — all in a safe, clean, and loving environment.",
  },
];
...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Nursery room with wooden rocking chair, portable crib, and moon wall decal",
    category: "interior",
  },
  {
    src: "/photos/photo-3.webp",
    alt: "Bright, spacious daycare or preschool classroom with toys, storage, and child-sized furniture.",
    category: "interior",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "Colorful children's dining room with blue table, red chairs, and fruit wall decals",
    category: "interior",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Yellow and white residential basketball hoop in sunny backyard with fence and trees",
    category: "product",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "Bright indoor playroom with circus tent, climbing structure, and educational toys",
    category: "interior",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Baby in pink outfit lying in white and pink portable play yard with toys",
    category: "product",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Colorful wooden puppet theater toy with clock, red curtains, and puppet characters.",
    category: "product",
  },
];
    ...
    <>
      ...
      <main>
        ...
        <div id="faq" className="bg-[var(--brand-bg-alt)]">
          <FAQAccordion
            heading="Questions Every Good Parent Should Ask"
            items={faqItems}
          />
        </div>
