...
const reviews: Review[] = [
  {
    text: "I was very happy with the flower arrangement I purchased for Valentine's Day. The service was efficient and timely, arriving in my requested time frame. I appreciated the reasonable prices on short notice and the quality of the flowers. I also bought chocolates and a candle that paired perfectly with the arrangement.",
    author: "Daniel Terbush",
    rating: 5,
    source: "google",
  },
  {
    text: "This place was awesome! Ordering was simple and my wife loved the flowers. I've ordered from many places and none were able to get the flowers delivered on time and to the correct place. Rothe not only did both but they crafted the most beautiful dozen rose bouquet I have ever ordered.",
    author: "Jim Lowther",
    rating: 5,
    source: "google",
  },
  {
    text: "I ordered an arrangement, designer's choice, to celebrate my sister-in-law's retirement. The designer created a beautiful arrangement and Anthony could not have been more kind and helpful taking my order and checking me out at the shop. I don't order flowers often but when I do, I'll be coming back here.",
    author: "Joan Brooks",
    rating: 5,
    source: "google",
  },
...
const galleryPhotos: Photo[] = [
  { src: "/photos/photo-3.webp", alt: "Custom floral arrangement", category: "work" },
  { src: "/photos/photo-4.webp", alt: "Flower delivery bouquet", category: "work" },
  { src: "/photos/photo-5.webp", alt: "Online order arrangement", category: "work" },
  { src: "/photos/photo-6.webp", alt: "Peace lily in basket", category: "work" },
  { src: "/photos/photo-7.webp", alt: "Gift add-ons with flowers", category: "work" },
  { src: "/photos/photo-8.webp", alt: "Holiday floral special", category: "work" },
];
  ...
  return (
    <>
      <Navbar
        ...
        ctaHref="tel:+12152470832"
      />

      {/* ── HERO: Blurred reveal with editorial typography ── */}
      <BlurredReveal
        src="/photos/photo-1.webp"
        alt="Rothe Florists & Flower Delivery exterior"
        height="140vh"
      >
        <div className="text-center px-6 max-w-4xl mx-auto">
          ...
          >
            Flowers That Actually Show Up Beautiful.
          </motion.p>
          <motion.div
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="font-[family-name:var(--font-display)] text-4xl md:text-5xl lg:text-6xl font-light leading-[1.1] mb-8">
              Where your vision becomes the arrangement.
            </h2>
            <p className="text-[var(--brand-muted)] leading-relaxed text-base max-w-md">
              Rothe Florists on Germantown Avenue has been serving Mt. Airy
              and Northwest Philadelphia for generations. Anthony and the team
              craft beautiful arrangements with care and attention. Ordering is
              simple, delivery is reliable, and the flowers always arrive
              looking stunning.
            </p>
          </motion.div>
            ...
            <ZoomOutReveal startScale={1.15} endScale={1}>
              <div className="gallery-card aspect-[3/4]">
                <img
                  ...
                  alt="Inside Rothe Florists & Flower Delivery"
      ...
      <ClickToCall phone="(215) 247-0832" />
    </>
  );
}
