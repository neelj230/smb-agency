...
// ── Photos ───────────────────────────────────────────────────────────────────
const heroPhoto: Photo = { src: '/photos/photo-1.webp', alt: 'Head Game photo 1', category: 'exterior' }
const aboutPhoto: Photo = { src: '/photos/photo-2.webp', alt: 'Head Game photo 2', category: 'interior' }
...
const services: Service[] = [
  {
    ...
    description: "Kevin's precision cut tailored to your hair type and style, executed efficiently so you're never left waiting long.",
    icon: 'scissors',
    image: '/photos/photo-3.webp',
  },
  {
    name: "Kids' First Haircut",
    description: 'A patient, gentle first-cut experience for young children, with the calm and care that nervous parents and kids both need.',
    icon: 'star',
    image: '/photos/photo-4.webp',
  },
  {
    name: "Boys' Regular Cut",
    description: 'Consistent, sharp cuts for boys of all ages, with a barber who knows how to keep kids comfortable and looking fresh.',
    icon: 'user',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Shape-Up & Edge',
    description: 'Clean line-up and edge work to keep your look defined and polished between full cuts.',
    icon: 'zap',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'Special Needs Accommodations',
    description: 'Kevin is experienced and patient with clients who have intellectual or sensory sensitivities, offering a calm and respectful experience every visit.',
    icon: 'heart',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Beard Trim & Lineup',
    description: 'Beard shaping and trimming to complement your cut and keep your overall look tight and well-maintained.',
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'Head Game is known for getting clients in and out quickly without long waits. Call ahead at (215) 883-1597 to check availability — walk-ins are welcome when Kevin has room.',
  },
  {
    question: 'What makes Kevin different from other barbers?',
    answer: "Kevin has been cutting the same customers' hair for 10 to 15+ years. He's fast, precise, and genuinely cares — customers bring their kids, and those kids grow up and keep coming back.",
  },
  {
    question: 'Is this a good shop for kids?',
    answer: "Absolutely. Kevin is known for giving first haircuts and has been cutting some clients' kids' hair since they were young children. He's calm, patient, and great with all ages.",
  },
  {
    question: 'Does Kevin work with clients who have special needs?',
    answer: 'Yes. Multiple customers specifically praise Kevin\'s patience and courtesy with clients who have intellectual or sensory sensitivities. Every visit is handled with care and respect.',
  },
]
...
export default function HeadGamePage() {
  return (
    <>
      ...
      <div style={{ '--brand-primary': '#1e64e6', '--brand-accent': '#f6e304', '--brand-text': '#111111' } as React.CSSProperties}>
