...
const services: Service[] = [
  {
    ...
    description:
      "Precise tailoring of men's and women's suits for a sharp, custom fit — including sleeves, waist, chest, and trouser hemming.",
    icon: "scissors",
  ...
  },
  {
    ...
    description:
      "Expert fitting and alteration of formal dresses, including complex embellished fabrics like sequins and feather-trimmed garments.",
    icon: "sparkles",
  ...
  },
  {
    name: "Garment Lining",
    description:
      "Professional lining installation or repair for dresses, jackets, and suits to extend the life and structure of your clothing.",
    icon: "layers",
  ...
  },
  {
    ...
    description:
      "Skilled adjustments to structured and specialty garments including corsets, with fast turnaround when time is critical.",
    icon: "zap",
  ...
  },
  {
    ...
    description:
      "Comprehensive resizing for customers who fall between standard sizes, ensuring a perfect fit without compromise across the full garment.",
    icon: "ruler",
  ...
  },
  {
    ...
    description:
      "Rush and deadline-driven tailoring for awards ceremonies, weddings, galas, and other high-stakes events where looking perfect is non-negotiable.",
    icon: "calendar-check",
...
const team: TeamMember[] = [
  {
    ...
    credentials: [
      "Expert in embellished formal wear",
      "Lining and complex alteration specialist",
      "Owner of United Tailoring Shop",
    ],
  },
  {
    name: "Rodney",
    ...
    credentials: [
      "Men's suit alteration specialist",
      "Fast turnaround without sacrificing quality",
      "Praised for friendly and professional service",
    ],
  },
  {
    ...
    credentials: [
      "Family-trained tailor",
      "Praised for outstanding customer service",
      "Part of the United family team",
    ],
  },
];
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Turnaround times are impressively fast at United. Simple alterations like corset adjustments can be completed in under 10 minutes while you wait. More complex projects — such as full suit resizing with multiple alterations — are typically completed within one week. Deadline-driven work for events is accommodated, so let the team know your event date when you come in.",
  },
  {
    question:
      "Can you handle complex or embellished garments like sequin dresses?",
    answer:
      "Absolutely. United Tailoring Shop has experience altering highly detailed garments including sequin dresses with feather trim. Ms. Chris and her team have successfully lined and altered elaborate formal wear for major award ceremonies, so your special-occasion garment is in expert hands.",
  },
  {
    question: "What if I'm between sizes and need a lot of alterations done?",
    answer:
      "United specializes in exactly this situation. Customers who are petite, between standard sizes, or need extensive work done across an entire garment consistently report that United delivers a perfect fit — often on the first try — at prices that are still affordable. Don't let the scope of the alterations discourage you from coming in.",
  },
  {
    question: "What are your hours and when should I come in?",
    answer:
      "United Tailoring Shop is open Tuesday through Saturday from 2:00 PM to 7:00 PM. The shop is closed on Sundays and Mondays. These afternoon hours reflect the team's commitment to focused, quality work. No appointment information is listed, so calling ahead at (215) 229-7760 is recommended for larger projects.",
  },
  {
    question:
      "What makes United Tailoring Shop different from other tailors in Philadelphia?",
    answer:
      "Customers consistently point to three things: the quality of the craft (described as 'generations of knowledge'), the warmth and empathy of the team (Rodney, Ms. Chris, and her daughter are all praised by name), and the combination of speed and accuracy — most customers report their garments fit perfectly on the first try without needing additional adjustments.",
  },
  {
    question: "Do you alter both men's and women's clothing?",
    answer:
      "Yes. United regularly alters men's suits and women's garments including suits, formal dresses, and specialty items like corsets. The shop has experience across a wide range of fabrics and garment types, from structured tailored suits to delicate embellished formal wear.",
  },
];
...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "United Tailoring Shop photo 3",
    category: "work",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "United Tailoring Shop photo 4",
    category: "work",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "United Tailoring Shop photo 5",
    category: "work",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "United Tailoring Shop photo 6",
    category: "work",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "United Tailoring Shop photo 7",
    category: "work",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "United Tailoring Shop photo 8",
    category: "work",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "United Tailoring Shop photo 9",
    category: "work",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "United Tailoring Shop photo 10",
    category: "work",
  },
];
