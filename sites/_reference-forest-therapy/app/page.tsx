// REFERENCE: FOREST THERAPY — "Foresta" Framer original. Full-screen hero, Your First Session, benefits cards, Meet Sophia, 4-step process, Where the Magic Happens, nature pricing with leaf, testimonials, booking CTA
"use client";
...
const benefits = [
  {
    ...
    description:
      "Cortisol levels drop measurably after a single guided session in old-growth forest.",
  },
  {
    icon: Wind,
    title: "Deeper Breathing",
    description:
      "Phytoncides from trees expand lung capacity and strengthen your immune response naturally.",
  },
  {
    icon: Sun,
    title: "Restored Energy",
    description:
      "Nature resets cognitive fatigue. You leave feeling lighter and more awake than when you arrived.",
  },
  {
    icon: Brain,
    title: "Mental Clarity",
    description:
      "Attention restoration in practice — the forest quiets the noise so you can think clearly again.",
  },
];
...
const processSteps = [
  {
    ...
    description:
      "A brief conversation to understand your intentions, any health considerations, and what you hope to find in the forest.",
  },
  {
    number: "02",
    title: "Preparation",
    description:
      "You receive a short guide on what to wear, what to bring, and a grounding exercise to do the morning of your session.",
  },
  {
    number: "03",
    title: "The Session",
    description:
      "Two hours of guided sensory immersion. Slow walking, deep listening, tea ceremony. The forest is the therapist.",
  },
  {
    number: "04",
    title: "Integration",
    description:
      "A follow-up reflection to help you carry the experience forward. Journaling prompts and practices for everyday stillness.",
  },
];

const sophiaCredentials = [
  "ANFT Certified Guide",
  "M.S. Environmental Psychology",
  "400+ guided sessions",
...
const pricingTiers = [
  {
    ...
    period: "per session",
    features: [
      "2-hour guided forest walk",
      "Tea ceremony included",
      "Small group (max 8)",
      "Sensory immersion exercises",
    ],
    highlighted: false,
  },
  {
    ...
    features: [
      ...
      "Seasonal rotation of trails",
      "Take-home nature journal",
      "Priority booking",
      "Save $40",
    ],
    highlighted: true,
...
const reviews = [
  {
    text: "I came skeptical and left transformed. Sophia guided us to truly see the forest — not just walk through it. The tea ceremony at the end was deeply moving.",
    author: "Rachel M.",
    detail: "First-time participant",
  },
  {
    text: "After six months of weekly walks, my anxiety medication dosage has been halved. My therapist recommended this and I cannot thank her enough.",
    author: "David K.",
    detail: "Monthly member",
  },
  {
    text: "The corporate retreat was unlike anything our team has experienced. We came back more connected and collaborative than any team-building exercise.",
    author: "Priya S.",
    detail: "Team lead, Comcast",
  },
  {
    text: "Sophia has a gift for slowing time. Two hours in the Wissahickon with her feels like a week of vacation.",
    author: "Tom W.",
...
const businessContact = {
  ...
  address: "42 Wissahickon Trail, Philadelphia, PA 19118",
};
...
export default function ForestTherapyPage() {
