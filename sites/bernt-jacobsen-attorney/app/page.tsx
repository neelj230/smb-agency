// Bernt Jacobsen Attorney — Tigard, OR — law firm
"use client";
...
const businessContact = {
  ...
  phone: "(503) 892-9301",
  email: "",
  tagline: "Gets It Done. Every Time.",
  hours: {
...
const services = [
  {
    ...
    description:
      "One-on-one consultations where Bernt Jacobsen evaluates your situation and builds a clear, actionable legal strategy tailored to your goals.",
    icon: "MessageSquare",
  },
  {
    name: "Contract Review & Drafting",
    description:
      "Thorough review and drafting of contracts to protect your interests before you sign or negotiate any binding agreement.",
    icon: "FileText",
  },
  {
    name: "Business Law & Transactions",
    description:
      "Legal guidance for business formation, operations, disputes, and transactional matters to keep your business on solid legal ground.",
    icon: "Briefcase",
  },
  {
    name: "Civil Litigation & Dispute Resolution",
    description:
      "Assertive representation in civil disputes — in court or at the negotiating table — with a focus on achieving real outcomes efficiently.",
    icon: "Scale",
  },
  {
    name: "Estate Planning & Documents",
    description:
      "Wills, powers of attorney, and estate planning documents drafted with precision to protect you and your family's future.",
    icon: "Shield",
  },
  {
    name: "Real Estate Legal Services",
    description:
      "Legal support for residential and commercial real estate transactions, title issues, and property disputes in the Portland metro area.",
    icon: "Home",
  },
];
...
const reviews = [
  {
    text: "The attorney who gets it done!",
    author: "Simply Exhausted",
    rating: 5,
    source: "google",
  },
];
...
const stats = [
  ...
  },
  {
    value: 8,
    suffix: " AM",
    label: "Early Start Every Weekday",
  },
  {
    value: 1,
    suffix: "",
    label: "Focused Attorney, Undivided Attention",
  },
];

const faq = [
  {
    question: "What makes Bernt Jacobsen different from other Portland attorneys?",
    answer:
      "Clients sum it up themselves: 'The attorney who gets it done.' Bernt Jacobsen is known for cutting through complexity, communicating clearly, and delivering real results — not just legal opinions. The focus is on your outcome, not billable hours.",
  },
  {
    question: "How do I schedule a consultation?",
    answer:
      "You can reach the office directly by phone at (503) 892-9301. The office is open Monday through Thursday from 8:00 AM to 5:00 PM and Friday from 8:00 AM to 3:00 PM. Calling early in the week gives you the best chance of a same-week appointment.",
  },
  {
    question: "What types of legal matters does this firm handle?",
    answer:
      "While specific practice areas vary, the firm's reputation is built on practical, results-driven legal work. Common areas for a firm of this profile include business law, contracts, civil disputes, estate planning, and real estate matters. Call to discuss your specific situation.",
  },
  {
    question: "Is the firm accepting new clients?",
    answer:
      "The best way to find out is to call (503) 892-9301 during business hours. Given the firm's focused model, Bernt Jacobsen is selective about caseload to ensure every client receives full attention.",
  },
  {
    question: "Where is the office located and is there parking?",
    answer:
      "The office is located at 7609 SW Beveland St, Portland, OR 97223, in the Tigard area of southwest Portland. The location is easily accessible from major southwest Portland routes with convenient local parking typical of the area.",
  },
  {
    question: "Does the firm offer free initial consultations?",
    answer:
      "Consultation policies vary. Contact the office directly at (503) 892-9301 to ask about initial consultation options and how to best describe your legal matter before your first appointment.",
  },
];

const brandNarrative =
  "Bernt Jacobsen Attorney is the kind of law practice that earns its reputation through results, not rhetoric. With a perfect 5-star rating and a client who said it plainly — 'The attorney who gets it done!' — this is a firm built on execution. In a world where legal matters drag on, breed anxiety, and rarely deliver clear answers, Bernt Jacobsen cuts through the noise and moves things forward. That clarity is rare. Clients notice it immediately.\n\nLocated in Portland's southwest corridor on Beveland Street, the firm operates with disciplined hours — Monday through Thursday from 8 AM to 5 PM, and wrapping early on Fridays. This isn't a 24/7 legal mill grinding through volume. It's a focused, intentional practice where attention is the product. The compact hours signal something about the philosophy: quality over quantity, depth over breadth. When you get Bernt Jacobsen on your case, you get real legal focus.\n\nThe firm's identity is crystallized in four words left by a real client: 'The attorney who gets it done.' No fluff, no hedging — just a practitioner who delivers outcomes. In legal matters, that reputation is everything. Whether navigating complex personal legal challenges or steering a business through uncertain legal terrain, clients leave this office knowing they had an advocate who was actually in their corner and actually moved the needle.";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-8 min-h-[calc(100vh-64px)] flex flex-col justify-between">
        ...
        >
          <h1 className="font-[family-name:var(--font-display)] text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] xl:text-[6.5rem] font-bold leading-[1.05] tracking-tight text-center max-w-5xl">
            ...
            <br />
            <span className="text-[var(--brand-primary)]">Every</span>{" "}
            single time.
          </h1>
        </motion.div>
...
function ScrollTextReveal() {
  ...
  const fullText =
    "We handle your legal challenges so you can focus on what matters most.";
      ...
      <div className="relative z-10 p-8 flex flex-col justify-between h-full">
        <div>
          ...
          <p className="text-sm text-white/70 max-w-xs leading-relaxed">
            ...
            legal representation that delivers real results.
          </p>
        </div>
        <div className="flex items-center gap-2 text-xs text-white/60">
          <CircleDot size={10} className="text-white" />
          <span>Focused legal advocacy</span>
        </div>
      </div>
    </div>
  );
        ...
        >
          ...
          >
            ...
            <div className="relative group cursor-pointer overflow-hidden rounded-2xl h-[380px]">
              <ProductImage src={PRODUCT_IMAGES.neuralCore} alt="Civil Law" />
...
function OurServices() {
  ...
  const services = [
    ...
    },
    {
      num: "02",
      title: "Architecture",
      desc: "Comprehensive legal guidance for business formation, operations, and disputes.",
      tag: "architecture",
      image:
          ...
          <motion.div variants={fadeUp} className="mb-12">
            ...
            <div className="flex items-start justify-between gap-8">
              <div className="flex items-start gap-8">
                ...
                <p className="text-[var(--brand-muted)] max-w-md leading-relaxed">
                  Practical legal solutions tailored to your specific situation.
                </p>
              </div>
            ...
            <div className="glass-card rounded-2xl p-8 flex flex-col justify-between relative overflow-hidden">
              <div>
                ...
                <p className="text-sm text-[var(--brand-muted)] leading-relaxed max-w-sm">
                  ...
                  to your legal needs. Our firm&apos;s key capabilities
                  include:
                </p>
              </div>
  ...
  const steps = [
    {
      ...
      fullDesc:
        "Bernt Jacobsen evaluates your legal situation and builds a clear, actionable strategy. One consultation is all it takes to understand your options and chart a path forward.",
      metric: "30",
      metricUnit: "sec",
    ...
    },
    {
      ...
      title: "Deep Scan",
      fullDesc:
        "Thorough case analysis identifies key issues, potential risks, and strategic opportunities across your entire legal situation.",
      metric: "500+",
      metricUnit: "",
    ...
    },
    {
      ...
      title: "Auto Guard",
      fullDesc:
        "Diligent case management with proactive communication and thorough preparation to protect your interests at every stage.",
      metric: "<1",
      metricUnit: "ms",
        ...
        >
          ...
          >
            <div className="flex marquee-track-reverse">
              {[
                "Now accepting new clients in the Portland metro area",
...
function Pricing() {
  ...
  const plans = [
    ...
    },
    {
      ...
      desc: "Comprehensive legal representation for complex matters.",
      features: [
        "Everything in Scale",
        "1TB Storage",
        "Custom SLA",
...
function FAQ() {
  ...
  const faqs = [
    {
      q: "What types of legal matters does Bernt Jacobsen handle?",
      a: "The firm handles business law, contracts, civil disputes, estate planning, and real estate matters. Call (503) 892-9301 to discuss your specific situation.",
    },
    {
    ...
    },
    {
      ...
      a: "Call the office at (503) 892-9301. Office hours are Monday through Thursday 8 AM to 5 PM, and Friday 8 AM to 3 PM.",
    },
    {
