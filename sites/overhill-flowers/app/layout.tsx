...
export const metadata: Metadata = {
  ...
  description:
    "Overhill Flowers is a florist located in Philadelphia, PA. Beautiful blooms, delivered when it matters.",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${instrument_serif.variable} ${inter.variable} ${mono.variable}`}
    >
      <head>
