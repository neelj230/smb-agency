...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: 'Overhill Flowers photo 3', category: 'work' },
  { src: '/photos/photo-4.webp', alt: 'Overhill Flowers photo 4', category: 'work' },
  { src: '/photos/photo-5.webp', alt: 'Overhill Flowers photo 5', category: 'work' },
  { src: '/photos/photo-6.webp', alt: 'Overhill Flowers photo 6', category: 'work' },
  { src: '/photos/photo-7.webp', alt: 'Overhill Flowers photo 7', category: 'work' },
  { src: '/photos/photo-8.webp', alt: 'Overhill Flowers photo 8', category: 'work' },
  { src: '/photos/photo-9.webp', alt: 'Overhill Flowers photo 9', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'Overhill Flowers photo 10', category: 'work' },
]
...
const faqItems: FAQItem[] = [
  {
    question: 'Can you create a custom arrangement for a specific occasion or event?',
    answer:
  ...
  {
    question: 'What if I have specific flower preferences or want to exclude certain flowers?',
    answer:
