...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Black and white French Bulldog sitting on blue blanket in car interior",
    category: "product",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "White and tan dog standing on garden path looking at camera",
    category: "product",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "White fluffy dog with black collar and heart tag sitting indoors",
    category: "product",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "White fluffy dog wearing colorful collar sitting in car backseat",
    category: "product",
  },
];
...
const services: Service[] = [
  {
    name: "Nail Trim & File",
    description:
      "Quick, precise nail trimming and filing — gentle enough for anxious or trauma-sensitive dogs, with same-day walk-in availability.",
    icon: "scissors",
  ...
  },
  {
    ...
    description:
      "Complete bath, brush-out, haircut, and styling tailored to your dog's breed and coat condition, even if the fur has gotten extra long.",
    icon: "sparkles",
  ...
  },
  {
    ...
    description:
      "Professional anal gland relief performed with care and efficiency, especially helpful for dogs who are skittish or uncomfortable with the process.",
    icon: "heart",
  ...
  },
  {
    name: "Bath & Brush-Out",
    description:
      "A thorough shampoo and brush session to freshen up your pup's coat between full grooming appointments.",
    icon: "droplets",
  ...
  },
  {
    ...
    description:
      "No appointment needed — call ahead, come in within a few hours, and get nails trimmed and filed in under 15 minutes.",
    icon: "zap",
  },
  {
    name: "Anxious & Rescue Dog Grooming",
    description:
      "Patient, low-stress grooming handling for dogs with trauma histories or high anxiety — every dog is treated with calm and compassion.",
    icon: "shield",
  },
];
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Walk-ins are welcome for quick services like nail trims. Customers have called ahead and been seen within a few hours on the same day.",
  },
  {
    question: "How do you handle dogs that are anxious or scared of grooming?",
    answer:
      "Patience and calm handling are at the heart of every appointment here. Marlyna's has successfully groomed rescue dogs with trauma histories and high-anxiety pups — every dog is treated at their own pace.",
  },
  {
    question: "How long does a nail trim actually take?",
    answer:
      "Most nail trim visits are in and out in 5 to 15 minutes. Nails are trimmed and filed for a clean, smooth finish — no long wait, no fuss.",
  },
  {
    question: "What are your hours and which days are you open?",
    answer:
      "Marlyna's is open Tuesday through Saturday from 8:00 AM to 4:30 PM. The shop is closed on Sundays and Mondays.",
  },
];
