...
const galleryPhotos: Photo[] = [
  { src: '/photos/photo-3.webp', alt: 'June The Barber photo 3', category: 'work' },
  { src: '/photos/photo-4.webp', alt: 'June The Barber photo 4', category: 'work' },
  { src: '/photos/photo-5.webp', alt: 'June The Barber photo 5', category: 'work' },
  { src: '/photos/photo-6.webp', alt: 'June The Barber photo 6', category: 'work' },
  { src: '/photos/photo-7.webp', alt: 'June The Barber photo 7', category: 'work' },
  { src: '/photos/photo-8.webp', alt: 'June The Barber photo 8', category: 'work' },
  { src: '/photos/photo-9.webp', alt: 'June The Barber photo 9', category: 'work' },
  { src: '/photos/photo-10.webp', alt: 'June The Barber photo 10', category: 'work' },
];

const services: Service[] = [
  {
    name: 'Kids Haircut',
    description: 'A patient, child-friendly cut tailored for boys who may be nervous about clippers or new to the barbershop experience.',
    icon: 'scissors',
    image: '/photos/photo-3.webp',
  },
  {
    name: "Men's Haircut & Style",
    description: 'A precision cut with clean lines and personal attention, taking the time to get it exactly right without rushing.',
    icon: 'user',
    image: '/photos/photo-4.webp',
  },
  {
    name: 'Shape-Up & Edge Work',
    description: 'Crisp, defined edges that keep your look sharp and fresh for weeks after the appointment.',
    icon: 'pen-tool',
    image: '/photos/photo-5.webp',
  },
  {
    name: 'Fade',
    description: "Seamless taper and fade cuts customized to each client's head shape and style preference.",
    icon: 'layers',
    image: '/photos/photo-6.webp',
  },
  {
    name: 'First-Time Cut (New Clients)',
    description: 'An introductory appointment designed to build comfort and trust, especially for kids trying a new barber for the first time.',
    icon: 'star',
    image: '/photos/photo-7.webp',
  },
  {
    name: 'Same-Day & Flexible Booking',
    description: 'Appointment scheduling through Booksy with fast response times and flexible availability, including evenings and weekends.',
    icon: 'calendar',
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'Absolutely. Multiple parents specifically praise June for his patience and ability to calm anxious children. As one mom shared, her son came in nervous and left looking like "the young handsome man that he is." June takes the time to build trust before picking up a single tool.',
  },
  {
    question: 'How do I book an appointment?',
    answer: 'You can book directly through Booksy at juniestakz.booksy.com. June is known for fast response times after booking, so you\'ll hear back quickly and can get on the schedule without the runaround.',
  },
  {
    question: 'How long does a cut stay looking fresh?',
    answer: "Customers have noted their sons' cuts still looked clean and fresh up to two weeks after the appointment — a sign of precise technique and attention to detail.",
  },
  {
    question: 'Does June rush through appointments?',
    answer: 'Not at all. Both parents and adult clients consistently highlight that June takes his time with every cut and never rushes — which is especially important for kids getting used to the barbershop.',
  },
];
...
const marqueeWords = [
  'Fresh Cuts', '★ 4.9 Rated', 'Kid-Friendly', 'No Rush', 'Philly\'s Best',
  'Clean Fades', 'Sharp Edges', 'Open Daily', 'Fresh Cuts', '★ 4.9 Rated',
  'Kid-Friendly', 'No Rush', 'Philly\'s Best', 'Clean Fades', 'Sharp Edges', 'Open Daily',
];
      ...
      <div className="june-marquee-track">
        {marqueeWords.map((word, i) => (
          <span key={i} className="june-marquee-item">
            {word}
            <span className="june-marquee-dot" aria-hidden>·</span>
          </span>
        ))}
      </div>
    </div>
