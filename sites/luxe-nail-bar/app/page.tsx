...
const galleryPhotos: Photo[] = [
  {
    ...
    alt: "Luxe Nail Bar photo 3",
    category: "work",
  },
  {
    src: "/photos/photo-4.webp",
    alt: "Luxe Nail Bar photo 4",
    category: "work",
  },
  {
    src: "/photos/photo-5.webp",
    alt: "Luxe Nail Bar photo 5",
    category: "work",
  },
  {
    src: "/photos/photo-6.webp",
    alt: "Luxe Nail Bar photo 6",
    category: "work",
  },
  {
    src: "/photos/photo-7.webp",
    alt: "Luxe Nail Bar photo 7",
    category: "work",
  },
  {
    src: "/photos/photo-8.webp",
    alt: "Luxe Nail Bar photo 8",
    category: "work",
  },
  {
    src: "/photos/photo-9.webp",
    alt: "Luxe Nail Bar photo 9",
    category: "work",
  },
  {
    src: "/photos/photo-10.webp",
    alt: "Luxe Nail Bar photo 10",
    category: "work",
  },
];
...
const services: Service[] = [
  {
    name: "Gel Manicure",
    description:
      "Long-lasting gel color applied over your natural nails for a clean, glossy finish starting at $35.",
    icon: "sparkles",
  ...
  },
  {
    name: "Gel-X Full Set",
    description:
      "Soft gel nail extensions applied over tips for added length and strength without acrylic.",
    icon: "wand-2",
  ...
  },
  {
    ...
    description:
      "Traditional manicure with shaping, cuticle care, and your choice of polish color.",
    icon: "hand",
  ...
  },
  {
    ...
    description:
      "Custom nail art created to match your inspiration photo, from minimalist accents to detailed looks.",
    icon: "paintbrush",
  ...
  },
  {
    name: "Pedicure",
    description:
      "Relaxing foot soak, exfoliation, and polish in a full pedicure service.",
    icon: "footprints",
  ...
  },
  {
    name: "Nail Repair",
    description:
      "Single nail repair or fill service to fix breaks and maintain your existing set.",
    icon: "wrench",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Most walk-in customers report being seated within 5–10 minutes of arriving, making Luxe Nail Bar one of the faster turnaround salons in West Philly.",
  },
  {
    question: "What are the prices for a gel manicure?",
    answer:
      "Gel manicures start at around $35 for a single color and run up to $50 or more for custom or detailed looks — pricing that customers consistently call fair for the area.",
  },
  {
    question: "Can I bring an inspiration picture for nail art?",
    answer:
      "Yes — the team actively works with inspiration photos and will try to match your look as closely as possible, including color and shape.",
  },
  {
    question: "Are there specific nail techs I should request?",
    answer:
      "Richard and Kevin are both named by satisfied customers for their quality work and friendly approach. If you have a preference, feel free to ask when you walk in.",
  },
];
...
const processSteps: ProcessStep[] = [
  {
    title: "Walk In",
    description:
      "No appointment needed. Most guests are seated within 5–10 minutes of arriving.",
  },
  {
    title: "Pick Your Look",
    description:
      "Browse colors, shapes, and nail art. Bring an inspo photo — the team will match it.",
  },
  {
    title: "Leave Polished",
    description:
      "Fresh set, fair price. The artists work until you love every nail.",
  },
];
    ...
    <>
      ...
      <section id="about" className="luxe-section-dark py-20 lg:py-28">
        ...
        >
          <motion.p
            variants={fadeUp}
            className="luxe-eyebrow luxe-eyebrow--light"
          >
            The Bar
          </motion.p>
          <motion.h2
            variants={fadeUp}
            className="luxe-heading luxe-heading--light mb-12"
          >
            On 40th Street
          </motion.h2>
          <AboutSection
