  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-black/[0.08] shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col justify-between min-w-[320px]">
      <div>
        ...
        <p className="mt-5 text-[var(--brand-text)] text-base leading-relaxed line-clamp-4">&ldquo;{review.text}&rdquo;</p>
      </div>
...
export function TestimonialCarousel({
  ...
  const reviews = rawReviews.filter(r => r.text && r.text.trim().length >= 20)
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div {...fadeInUp}>
            <div className="bg-[var(--brand-primary)] text-white rounded-3xl p-10 md:p-16 mb-10 relative overflow-hidden">
              <div className="absolute top-6 left-10 text-8xl leading-none opacity-20 font-serif">&ldquo;</div>
              <p className="text-xl md:text-2xl lg:text-3xl leading-relaxed mt-4 relative z-10">{featured.text}</p>
