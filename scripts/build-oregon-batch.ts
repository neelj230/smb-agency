...
async function main() {
  ...
  const ranked = [...deduped.values()]
    ...
    .sort((a, b) => {
      ...
      const tierDiff =
        tierOrder[a.priority_tier as keyof typeof tierOrder] -
        tierOrder[b.priority_tier as keyof typeof tierOrder];
      if (tierDiff !== 0) return tierDiff;
      if (a.website_score !== b.website_score)
        return a.website_score - b.website_score;
